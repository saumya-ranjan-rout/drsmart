...
class Prescription_model extends CI_Model
{
    ...
    public function getPrescriptionByIPD($id, $ipdid, $visitid = '')
    {
        ...
        $query = $this->db->select('ipd_prescription_details.*,medicine_category.medicine_category,ipd_prescription_details.dosage as dosageid,medicine_dosage.dosage')
    ...
    function getMaxId()
    {
        $query = $this->db->select('max(id)as presno')->get("ipd_prescription_basic");
        $result = $query->row_array();
        return $result["presno"];
    }
}
