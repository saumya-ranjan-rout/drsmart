...
class Mailsms extends Admin_Controller {
   ...
   public function index() { 
        ...
        if ($this->input->server('REQUEST_METHOD') == 'POST') {
            ...
            redirect('admin/mailsms/index?search_type=' . $search_type);
        }
        ...
        if (empty($search_type)) {
            ...
            $additional = array();  // Currently not used but placeholder for future additions
            $additional_where = array();  // Currently not used but placeholder for future additions
