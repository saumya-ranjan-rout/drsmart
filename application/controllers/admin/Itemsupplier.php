...
class Itemsupplier extends Admin_Controller
{
    ...
    function add()
    {
        ...
        $this->form_validation->set_rules('phone', $this->lang->line('phone'), 'trim|required|callback_valid_mobile_number');
        ...
        // $this->form_validation->set_rules('contact_person_phone', $this->lang->line('contact') . " " . $this->lang->line('person') . " " . $this->lang->line('phone'), 'trim|required|callback_valid_mobile_number');
        $this->form_validation->set_rules('contact_person_phone', $this->lang->line('contact_person_phone'), array(array('valid_emg_contact', array($this->staff_model, 'valid_emg_contact'))));
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $countryCode1 = $this->input->post('countryCode2');
            $number1 = $this->input->post('contact_person_phone');

            $data = array(
                //'phone' => $this->input->post('phone'),
                'phone' => $countryCode . $number,
                //'contact_person_phone' => $this->input->post('contact_person_phone'),
                'contact_person_phone' => $countryCode1 . $number1,
                'item_supplier' => $this->input->post('name'),
                'email' => $this->input->post('email'),
                'address' => $this->input->post('address'),
                'contact_person_name' => $this->input->post('contact_person_name'),
    ...
    function edit()
    {
        ...
        $this->form_validation->set_rules('name', $this->lang->line('name'), 'trim|required|xss_clean');
        //$this->form_validation->set_rules('phone', $this->lang->line('phone'), 'trim|numeric|xss_clean');
        $this->form_validation->set_rules('phone1', $this->lang->line('phone'), 'trim|required|callback_valid_mobile_number');
        $this->form_validation->set_rules('email', $this->lang->line('email'), 'trim|xss_clean|valid_email');
        //$this->form_validation->set_rules('contact_person_phone', $this->lang->line('contact') . " " . $this->lang->line('person') . " " . $this->lang->line('phone'), 'trim|numeric|xss_clean');
        //     $this->form_validation->set_rules('contact_person_phone1', $this->lang->line('contact') . " " . $this->lang->line('person') . " " . $this->lang->line('phone'), 'trim|required|callback_valid_mobile_number');
        $this->form_validation->set_rules('contact_person_phone1', $this->lang->line('contact_person_phone'), array(array('valid_emg_contact', array($this->staff_model, 'valid_emg_contact'))));
        $this->form_validation->set_rules('contact_person_email', $this->lang->line('email'), 'trim|xss_clean|valid_email');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $msg = array(
                ...
                'email' => form_error('email'),
                'contact_person_phone1' => form_error('contact_person_phone1'),
                'contact_person_email' => form_error('contact_person_email'),
            );
            ...
            $countryCode2 = $this->input->post('countryCode3');
            $number2 = $this->input->post('phone1');

            $countryCode3 = $this->input->post('countryCode4');
            $number3 = $this->input->post('contact_person_phone1');

            $data = array(
                'id' => $id,
                //'phone' => $this->input->post('phone'),
                'phone' => $countryCode2 . $number2,
                //'contact_person_phone' => $this->input->post('contact_person_phone'),
