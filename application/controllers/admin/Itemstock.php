...
class Itemstock extends Admin_Controller {
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('quantity', $this->lang->line('quantity'), 'trim|required|xss_clean|callback_check_quantity');
    ...
    if (!is_numeric($quantity) || $quantity <= 0) {
        $this->form_validation->set_message('check_quantity', $this->lang->line('quantity_must_be_greater_than_zero'));
        return FALSE;
    }
    return TRUE;
   }
