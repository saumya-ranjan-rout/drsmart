...
class dashboard extends Patient_Controller {
    ...
    public function getCharges($id)
    {
        ...
        $data['result'] = $result;
        $this->load->view('patient/opdchargesprint', $data);
    }
    ...
    public function getPrintPayments($id)
    {
        ...
        $data['result'] = $result;
        $this->load->view('patient/printopdpayment', $data);
    }
    ...
    public function getIpdCharges($id)
    {
        ...
        $this->load->view('patient/ipdchargesprint', $data);
    }
    ...
    public function getIpdPayments($id)
    {
        ...
        $data['result'] = $result;
        $this->load->view('patient/printipdpayment', $data);
    }
}
