                    ...
                    <div class="pull-right">
                        ...
                        <div class="navbar-custom-menu">
                            <ul class="nav navbar-nav headertopmenu">
                                ...
                                ?>
                                            <li class="cal15"><a href="<?php echo base_url(); ?>admin/pharmacy/expired_medicine" title="<?php echo $this->lang->line('expired_medicines'); ?>"><i class="fa fa-bell-o"></i>
                                                    <?php ?>
                                                    <span class="label label-danger"><?php echo sizeof($expirynotifications) ?></span></a></li>
                                <?php }
                                    }
                                } ?>
                                <?php if ($this->rbac->hasPrivilege('notification_center', 'can_view')) {
                                ...
                                ?>
                                        <li class="cal15"><a href="<?php echo base_url() . "admin/systemnotification" ?>" title="<?php echo $this->lang->line('system') . " " . $this->lang->line('notifications'); ?>"><i class="fa fa-bell-o"></i>
                                                <?php ?>
                            ...
                            <!-- <img src="<?php echo base_url() . "uploads/hospital_content/logo/01.png" ?>" class="logowidth" style="width:20%; margin-top: 5px"> -->
                            <li class="dropdown user-menu">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">
                                    <img src="<?php echo base_url() . "uploads/hospital_content/logo/01.png" ?>" class="topuser-image logowidth" alt="User Image" style="width:100%;border-radius: 0px;">
                                </a>
                            </li>
