                                ...
                                <div class="media mt5" style="padding:0 10px;">
                                    ...
                                    <div class="media-body">
                                        <p class="tododesc" <?php if ($taskvalue["is_active"] == 'yes') {
                                                            ?> style="text-decoration: line-through;color: #4f881d;" <?php } ?>><?php echo $taskvalue["event_title"]; ?>
                                        </p>
                                        <small class="tododate">
                                            <!-- <?php echo date("m/d/Y", strtotime($taskvalue["start_date"])); ?> -->
                                            <?php echo date($this->customlib->getSchoolDateFormat(true, false), strtotime($taskvalue['start_date'])); ?>
