                ...
                <div class="box box-primary" <?php
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('age') ?></b> <a class="pull-right text-aqua">
                                    <?php
                                    if (!empty($result['age'])) {
                                                    ...
                                                    <td class="pull-right">
                                                        <?php if ($value["prescription"] == 'yes') { ?>
                                                            <?php if (chkexist($prescription_detail, $value["id"])) { ?>
                                                                ...
                                                                <a href='#' class="btn btn-default btn-xs" data-toggle='tooltip' onclick="print('<?php echo $value["id"] ?>', '<?php echo $value["id"] ?>')" title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a>
                                                        <?php }
                                                        }
                                                        ?>
