                ...
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            ...
                            <td align="right"><h5><?php echo $this->lang->line('reporting') ." ". $this->lang->line('date') . " : "; ?><?php echo date($this->customlib->getSchoolDateFormat(true, true), strtotime($result['reporting_date'])) ?></h5>
                            </td>
                        </tr>
                    </table>
