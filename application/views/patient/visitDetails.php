                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a onclick="printCharges('<?php echo $charges_value['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('print'); ?>">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a onclick="printPayment('<?php echo $payment['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="print">
                                                            <i class="fa fa-print"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                            ...
                                            <tr class="box box-solid total-bg">
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td class="text-right"><?php echo $this->lang->line('total') . " : " . $currency_symbol . "" . $total; ?></td>
                                                <td></td>
                                            </tr>
                                    </tbody>
...
<script type="text/javascript">
    ...
    function printCharges(id) {
        ...
        $.ajax({
            url: base_url + 'patient/dashboard/getCharges/' + id,
            type: 'POST',
            data: {
                payslipid: id,
                print: 'yes'
    ...
    function printPayment(id) {
        ...
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'patient/dashboard/getPrintPayments/' + id,
            type: 'POST',
            data: {
                payslipid: id,
                print: 'yes'
