                                    ...
                                    <?php if ($result["ipd_discharge"] != "no") { ?>
                                        <tr>
                                            <th class="bozerotop"><?php echo $this->lang->line('discharged') . " " . $this->lang->line('date');
                                                                    ?></th>
                                            <td class="bozerotop"><?php echo date($this->customlib->getSchoolDateFormat(), strtotime($result['discharge_date'])) ?><?php //echo date($this->customlib->getSchoolDateFormat($bill_info['discharge_date'])); 
                                                                                                                                                                    ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            ...
                                                            <a href='#prescription' class="btn btn-default btn-xs" onclick="printprescription('<?php echo $prescription_value["id"] ?>', '<?php echo $prescription_value["id"] ?>')" data-original-title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a>
                                                        </td>
                                                    </tr>
                                            <?php
                                                }
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <a onclick="printIpdCharges('<?php echo $charge['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="print">
                                            ...
                                            <table class="nobordertable table table-striped table-responsive">
                                                <form method="post" id="add_bill" enctype="multipart/form-data">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right ipdbilltable fontbold20">
                                                            <input type="hidden" id="other_charge"
                                                                value="<?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right ipdbilltable fontbold20">
                                                            <input type="hidden" readonly name="net_amount"
                                                                value="<?php
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right"><?php echo $payment["paid_amount"] ?></td>
                                                        <td class="text-right">
                                                            <a onclick="printIpdPayment('<?php echo $payment['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="print">
                                                                <i class="fa fa-print"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                ...
                                                <tr class="box box-solid total-bg">
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td class="text-right"><?php echo $this->lang->line('total') . " : " . $total; ?></td>
                                                    <td></td>
                                                </tr>
                                        </tbody>
...
<script type="text/javascript">
    ...
    function printIpdCharges(id) {
        ...
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'patient/dashboard/getIpdCharges/' + id,
            type: 'POST',
            data: {
                payslipid: id,
                print: 'yes'
    ...
    function printIpdPayment(id) {
        ...
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'patient/dashboard/getIpdPayments/' + id,
            type: 'POST',
            data: {
                payslipid: id,
                print: 'yes'
