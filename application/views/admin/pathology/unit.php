            ...
            <div class="col-md-2">
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <li><a href="<?php echo base_url(); ?>admin/pathologycategory/unit" class="active"><?php echo $this->lang->line('unit'); ?></a></li>
                        <li><a href="<?php echo base_url(); ?>admin/pathologycategory/pathoparameter" ><?php echo $this->lang->line('pathology') . " " . $this->lang->line('parameter'); ?></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-10">              
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('unit') . " " . $this->lang->line('list'); ?></h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('pathology_category', 'can_add')) { ?>
                                <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add') . " " . $this->lang->line('unit'); ?></a> 
                            <?php } ?>    
                        </div>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label"><?php echo $this->lang->line('unit') . " " . $this->lang->line('name'); ?></div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('pathology_category', 'can_delete')) {
                                                    ?>
                                                    <a class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordById('<?php echo base_url(); ?>admin/pathologycategory/delete_unit/<?php echo $lab['id'] ?>', '<?php echo $this->lang->line('delete_message'); ?>')";>
                ...
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        ...
                        <div class="form-group">
                            ...
                            <input autofocus="" name="unit_name" placeholder="" type="text" class="form-control" autocomplete="off">
            ...
            <form id="editformadd" action="<?php echo site_url('admin/pathologycategory/addUnit') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('unit') . " " . $this->lang->line('name'); ?></label><small class="req"> *</small>
                            <input autofocus="" id="unit_name" name="unit_name" placeholder="" type="text" class="form-control" value="<?php
                            if (isset($result)) {
...
<script>
    ...
    function get(id) {
        ...
        $.ajax({
            dataType: 'json',
            url: '<?php echo base_url(); ?>admin/pathologycategory/get_data_unit/' + id,
