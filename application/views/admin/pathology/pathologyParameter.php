            ...
            <div class="col-md-2">
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <li><a href="<?php echo base_url(); ?>admin/pathologycategory/unit" ><?php echo $this->lang->line('unit'); ?></a></li>
                        <li><a href="<?php echo base_url(); ?>admin/pathologycategory/pathoparameter" class="active"><?php echo $this->lang->line('pathology') . " " . $this->lang->line('parameter'); ?></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-10">              
                    ...
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('pathology_category', 'can_add')) { ?>
                                <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add') . " " . $this->lang->line('pathology') . " " . $this->lang->line('parameter'); ?></a> 
                            <?php } ?>    
                        </div>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label"><?php echo $this->lang->line('pathology') . " " . $this->lang->line('parameter') . " " . $this->lang->line('name'); ?></div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('pathology_category', 'can_delete')) {
                                                    ?>
                                                    <a class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordById('<?php echo base_url(); ?>admin/pathologycategory/delete_parameter/<?php echo $lab['id'] ?>', '<?php echo $this->lang->line('delete_message'); ?>')";>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="formadd" action="<?php echo site_url('admin/pathologycategory/addPathoparameter') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"><?php echo $this->lang->line('edit') . " " . $this->lang->line('pathology') . " " . $this->lang->line('parameter'); ?></h4> 
            </div>


            <form id="editformadd" action="<?php echo site_url('admin/pathologycategory/addPathoparameter') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
