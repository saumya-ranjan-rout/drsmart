...
<script type="text/javascript">
    ...
    $(document).ready(function(e) {
        $("#formoutsourced").on('submit', (function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>admin/pathology/outsourcedPathologyTest',
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
    ...
    function viewDetail(id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#edit_delete').html("<?php if ($this->rbac->hasPrivilege('pathology test', 'can_edit')) { ?><a href='#'' onclick='getRecord(" + id + ")' data-target='#myModaledit' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php }
                                                                                                                                                                                                                                                                                                            if ($this->rbac->hasPrivilege('pathhology test', 'can_delete')) {
