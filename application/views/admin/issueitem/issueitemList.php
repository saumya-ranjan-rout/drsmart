            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('issue_item') ." ". $this->lang->line('list'); ?></h3>
 ...
 $(document).ready(function () {
        ...
        $('#issue_date').datepicker({
         ...
         //   $('#follow_up_date').datepicker('setStartDate', selectedDate); // Set follow-up date start after selected date
            $('#return_date').datepicker('setStartDate', selectedDate).prop('disabled', false); // Enable and set follow-up date start after selected date
...
$('#return_date').val(''); 
        ...
        $('#return_date').datepicker().on('changeDate', function (e) {
            var dateVal = $('#issue_date').datepicker('getDate');
            var followUpDateVal = $('#return_date').datepicker('getDate');

            if (followUpDateVal < dateVal) {
                alert("The Return date must be greater than the Issue date.");
                $('#return_date').val(''); // Clear invalid follow-up date
            }
        });
    });
                ...
                <div class="row ptt10">
                    <form id="form1" action="<?php echo base_url() ?>admin/issueitem/add"   name="itemstockform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <input id="issue_date" name="issue_date" placeholder="" type="text" class="form-control"  value="<?php echo date('d-m-Y'); ?>" readonly />
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <input id="return_date" name="return_date" placeholder="" type="text" class="form-control"  value="<?php echo date('d-m-Y'); ?>" readonly/>
