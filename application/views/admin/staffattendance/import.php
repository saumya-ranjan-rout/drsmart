            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('staff').' Import'; ?></h3>
                    </div><!-- /.box-header -->
                   
                   <form id='form1' action="<?php echo site_url('admin/staffattendance/download_csv') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body" >
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="box-footer">
                            <button type="submit" name="search" id="download-csv" value="search" class="btn btn-primary btn-sm pull-right checkbox-toggle showhide"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                        </div>
                    </form>
                  ...
                  <div id="showhide" >
                    <div class="box-body">    
                      <div class="box-tools pull-left">
                        ...
                        2. For attemdance_type  use Present, Absent, Late, Half Day, Holiday value.<br/>
                    ...
                    <form action="<?php echo site_url('admin/staffattendance/import') ?>" id="employeeform" name="employeeform" method="post" enctype="multipart/form-data">
                        <div class="box-body">
...
//         var staff=$('#class_id').val();
//         if(staff!="select"){
//          $('#showhide').toggle(); // Toggle the visibility of the div
//         }else{
//         $('#showhide').hide(); // Toggle the visibility of the div
//         }
