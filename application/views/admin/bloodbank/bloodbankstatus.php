                            ...
                            <table class="table table-striped table-bordered table-hover example" >
                                <thead>
                                    <tr>
                                       ...
                                       <?php if ($this->rbac->hasPrivilege('blood_bank_status', 'can_edit')) { ?>   <th class="text-right"><?php echo $this->lang->line('action'); ?></th> <?php } ?>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    foreach ($bloodGroup as $category) {
                                        ...
                                        <tr>
                                           ...
                                           <?php if ($this->rbac->hasPrivilege('blood_bank_status', 'can_edit')) { ?>   <td class="text-right">
...
$this->session->unset_userdata('msg'); ?>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <input autofocus="" id="status"  name="status" placeholder="" type="number" class="form-control"  value="<?php
                                if (isset($result)) {
                                    echo $result["status"];
                                }
                                ?>" />
