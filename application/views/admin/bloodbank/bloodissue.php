                        ...
                        <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    ?>
                                        <tr class="">
                                            <td><?php echo $blood['ref_no']; ?></a></td>
                                            <td><?php echo date($this->customlib->getSchoolDateFormat(true, true), strtotime($blood['date_of_issue'])) ?></td>
                                            <td><a><?php echo $blood['patient_name']; ?></a></td>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="#"
                                                    onclick="printData('<?php echo $blood['id'] ?>')"
                                                    class="btn btn-default btn-xs" data-toggle="modal"
                                                    title="<?php echo $this->lang->line('print'); ?>">
                                                    <i class="fa fa-print"></i>
                                                </a>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="date_of_issue" id="dates_of_issue" class="form-control datetimer">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="exampleInputFile">
                                    <?php echo $this->lang->line('hospital') . " " . $this->lang->line('doctor'); ?></label><small class="req"> *</small>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <small class="req">*</small>
                                <input type="text" id="doctname" name="doctor" class="form-control" readonly>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <small class="req"> *</small>
                                <input name="amount" type="text" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                    ...
                    <div class="row ptt10">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label><?php echo $this->lang->line('issue') . " " . $this->lang->line('date'); ?></label>
                                <small class="req"> *</small>
                                <input type="text" name="date_of_issue" id="date_of_issue" value="" class="form-control datetimer">
                                <span class="text-danger"><?php echo form_error('date_of_issue'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="doctor" id="doctor" value="<?php echo set_value('doctor'); ?>" class="form-control" readonly>
                            </div>
                            <span class="text-danger"><?php echo form_error('doctor'); ?></span>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="amount"><?php echo $this->lang->line('amount') . " (" . $currency_symbol . ")"; ?></label>
                                <small class="req"> *</small>
                                <input name="amount" type="text" id="amount" value="<?php echo set_value('amount'); ?>" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                                <span class="text-danger"><?php echo form_error('amount'); ?></span>
                            </div>
                        </div>
    ...
    function getRecord(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // $('select[id="edit_consultant_doctor"] option[value="' + data.doctor + '"]').attr("selected", "selected");
                $('select[id="edit_consultant_doctor"] option').filter(function() {
                    return $(this).text() == data.doctor;
                }).prop('selected', true);

                // Trigger change event to reflect the selection visually
                $('select[id="edit_consultant_doctor"]').trigger('change');
    ...
    function viewDetail(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log(data);
                var date_format = '<?php echo $results = strtr($this->customlib->getSchoolDateFormat(), ['d' => 'dd', 'm' => 'MM', 'Y' => 'yyyy',]) ?>';
                var chequedate = new Date(data.cheque_date).toString(date_format);
                ...
                $("#paymentMode").html(data.payment_mode);

                // Check if payment mode is Cheque
                if (data.payment_mode.toLowerCase() === "cheque") {
                    $("#chequeNo").html(data.cheque_no);
                    $("#chequeDate").html(chequedate);
                    // Show cheque fields if hidden
                    $("#chequeNo").closest('tr').show();
                    $("#chequeDate").closest('tr').show();
                } else {
                    // Hide cheque fields if not cheque payment mode
                    $("#chequeNo").closest('tr').hide();
                    $("#chequeDate").closest('tr').hide();
                }
