                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <small class="req"> *</small>
                                    <input type="text" name="dob" id="birth_date" placeholder="" class="form-control datee" /><?php echo set_value('dob'); ?>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('mobile_no'); ?></label><small class="req"> *</small>
                                    <div class="input-group" style="display:flex;">
                                        ...
                                        <input id="number" autocomplete="off" name="number" type="text" placeholder="" class="form-control" value="<?php echo set_value('contact_no'); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="dob"><?php echo $this->lang->line('date_of_birth'); ?></label>
                                        <small class="req"> *</small>
                                        <input type="text" name="dob" id="ebirth_date" placeholder="" class="form-control datee" /><?php echo set_value('dob'); ?>
                                        <span class="text-danger"><?php echo form_error('dob'); ?></span>
                                    </div>
                                </div>
                                <!-- <div class="col-sm-3">
                                ...
                                <div class="col-sm-4" id="calculate1">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('age') ?></label>
                                        <div style="clear: both;overflow: hidden;">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="display:flex;">
                                            ...
                                            <input id="number2" autocomplete="off" name="number2" type="text" placeholder="" class="form-control" value="<?php echo set_value('contact_no'); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <small class="req"> *</small>
                                        <input name="donate_date" type="text" class="form-control datee" />
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <small class="req"> *</small>
                                        <input name="quantity" type="text" class="form-control"  oninput="this.value = this.value.replace(/[^0-9]/g, '');"/>
                                        <span class="text-danger"><?php echo form_error('quantity'); ?></span>
                                    </div>
                                </div>
...
<script>
    ...
    //edit
    function CalculateAgeInQCe1(DOB, txtAge, Txndate) {
        if (DOB.value != '') {
    ...
    $(document).ready(function() {
        $("#ebirth_date").change(function() {
            ...
            var DOB = dayThen + "/" + monthThen + "/" + yearThen;
            //console.log(DOB);
            CalculateAgeInQCe1(DOB, '', new Date());
        });
    });
</script>