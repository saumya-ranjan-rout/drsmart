                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group" style="display:flex;">
                                        ...
                                        <input id="number" autocomplete="off" name="number" type="text" placeholder="" class="form-control" value="<?php echo set_value('contact_no'); ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="display:flex;">
                                            ...
                                            <input id="number2" autocomplete="off" name="number2" type="text" placeholder="" class="form-control" value="<?php echo set_value('contact_no'); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
