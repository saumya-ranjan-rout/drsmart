    ...
    <div class="modal-dialog modal-dialog2 modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form role="form" id="schsetting_form" accept-charset="utf-8" method="post" class="ptt10" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <select name="payment_mode" id="payment_mode"  class="form-control" onchange="getChequefields(this.value)">
                                <option value=""><?php echo $this->lang->line('select'); ?></option>
                                <?php
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6" id="cheque_no_div" style="display:none">
                                        ...
                                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6" id="cheque_date_div" style="display:none">
                                        ...
                                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6" id="cheque_doc_div" style="display:none">
                                            <label><?php echo $this->lang->line('attach_document'); ?></label>
                                            <input name="cheque_document" id="cheque_documnet" type="file" class="filestyle form-control" value="<?php echo set_value('cheque_document'); ?>" />
                                        </div>
                                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
...
var formData = new FormData($('#schsetting_form')[0]);
