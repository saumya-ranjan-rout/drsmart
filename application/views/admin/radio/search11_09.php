                            ...
                            <div class="row">    
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="report_days" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                    ...
                    <div class="ptt10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('report') . " " . $this->lang->line('days') ?></label>
                                    <input type="number" name="report_days" id="report_days" class="form-control" value="<?php echo set_value('report_days'); ?>">
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="apply_charge" id="apply_charge" class="form-control" >
                                        </div>
                                    </div> 
