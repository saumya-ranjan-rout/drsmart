            ...
            <div class="col-md-2">
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <li><a href="<?php echo base_url(); ?>admin/lab/unit" class="active"><?php echo $this->lang->line('unit'); ?></a></li>
                        <li><a href="<?php echo base_url(); ?>admin/lab/radioparameter" ><?php echo $this->lang->line('radiology') . " " . $this->lang->line('parameter'); ?></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-10">              
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('radiology_category', 'can_delete')) {
                                                    ?>
                                                    <a class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordById('<?php echo base_url(); ?>admin/lab/delete_unit/<?php echo $lab['id'] ?>', '<?php echo $this->lang->line('delete_message'); ?>')";>
...
<script>
    ...
    function get(id) {
        ...
        $.ajax({
            dataType: 'json',
            url: '<?php echo base_url(); ?>admin/lab/get_data_unit/' + id,
