...
<!--  onclick="holdModal('myOutsourcedTestModal')" -->
    <a href="<?php echo base_url(); ?>admin/Outesourced_Test/outsourcedPathologyTest" data-toggle="modal" class="btn btn-primary btn-sm"><i class="fa fa-reorder"></i> <?php echo'Outsourced' . " " . $this->lang->line('test'); ?></a>
<?php } ?>
                            <?php if ($this->rbac->hasPrivilege('radiology test', 'can_add')) { ?>
                        ...
                        <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    ?>
                                        <tr class="">
                                            <td><a href="#" onclick="viewDetail('<?php echo $student['id'] ?>')"><?php echo $student['test_name']; ?></a> </td>
                                            ...
                                            <td> <?php if ($this->rbac->hasPrivilege('add_radio_patient_test_reprt', 'can_add')) { ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="report_days" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                    ...
                    <div class="ptt10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('report') . " " . $this->lang->line('days') ?></label>
                                    <input type="text" name="report_days" id="report_days" class="form-control" value="<?php echo set_value('report_days'); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <small class="req">*</small>
                                    <div>
                                        <select class="form-control select2" style="width: 100%" onchange="getchargeDetails(this.value, 'edit_standard_charge')" name='charge_category_id' id="edit_code">
                                            <option value="<?php echo set_value('charge_category_id'); ?>"><?php echo $this->lang->line('select') ?></option>
                                        </select>
                                    </div>
                                    <span class="text-danger"><?php echo form_error('charge_category_id'); ?></span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="apply_charge" id="apply_charge" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
    ...
    function viewDetail(id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#edit_delete').html("<?php if ($this->rbac->hasPrivilege('radiology test', 'can_edit')) { ?><a href='#'' onclick='getRecord(" + id + ")'  data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php }
                if ($this->rbac->hasPrivilege('radiology test', 'can_delete')) { ?><a onclick='delete_record(" + id + ")'  href='#'  data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('delete'); ?>'><i class='fa fa-trash'></i></a><?php } ?>");
                holdModal('viewModal');
            },
        });
    }
