<div class="box border0">
    <ul class="tablists">
         <?php if ($this->rbac->hasPrivilege('appointment_print_header_footer', 'can_view')) { ?>
            <li><a href="<?php echo site_url('admin/printing/appointmentprinting') ?>" class="<?php echo set_sidebar_Submenu('admin/printing/appointmentprinting'); ?>"><?php echo $this->lang->line('appointment'); ?></a></li>
        ...
        <?php } if ($this->rbac->hasPrivilege('opd_bill_print_header_footer', 'can_view')  || $this->rbac->hasPrivilege('ipd_bill_print_header_footer', 'can_view')) { ?>

               <li> <a href="<?php echo site_url('admin/printing/paymentreceiptprinting') ?>" class="<?php echo set_sidebar_Submenu('admin/printing/paymentreceiptprinting'); ?>"><?php echo $this->lang->line('payment_receipt'); ?></a></li>
