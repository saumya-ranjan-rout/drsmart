                             ...
                             <div class="col-sm-6">
                                <div class="form-group">
                                        ...
                                        <div class="input-group" style="display:flex;">
                                            ...
                                            <input id="number" autocomplete="off" name="number"  type="text" placeholder="" class="form-control"  value="<?php echo set_value('contact'); ?>"  oninput="this.value = this.value.replace(/[^0-9]/g, '');"/>
                                        </div>
                                </div>
                            </div> 
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="edate" name="date" type="text" class="form-control datee" readonly="" />
