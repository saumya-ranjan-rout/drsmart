...
<div class="content-wrapper" style="min-height: 348px;">  
    ...
    <section class="content">
        <div class="row">
            ...
            <?php if ($this->rbac->hasPrivilege('setup_front_office', 'can_add') || $this->rbac->hasPrivilege('setup_front_office', 'can_edit')) { ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
...
$this->session->unset_userdata('msg'); ?>
            ...
            if ($this->rbac->hasPrivilege('setup_front_office', 'can_add') || $this->rbac->hasPrivilege('setup_front_office', 'can_edit')) {
                echo "6";
            } else {
                echo "10";
            }
