                          ...
                          <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group" style="display:flex;">
                                        ...
                                        <input id="phone" autocomplete="off" name="phone"  type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="" class="form-control"  value="<?php echo set_value('phone'); ?>" />
                       ...
                       <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('contact_person_phone'); ?></label>
                                <div class="input-group" style="display:flex;">
                                        ...
                                        <input id="contact_person_phone" autocomplete="off" name="contact_person_phone"  type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="" class="form-control"  value="<?php echo set_value('contact_person_phone'); ?>" />
                           ...
                           <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group" style="display:flex;">
                                        ...
                                        <input id="phone1" autocomplete="off" name="phone1"  type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="" class="form-control"  value="<?php echo set_value('phone'); ?>" />
                                        <span class="text-danger"><?php echo form_error('phone'); ?></span>
                                    </div>
                                </div>
                            </div> 
                       ...
                       <div class="form-group">
                             <label for="exampleInputEmail1"><?php echo $this->lang->line('contact_person_phone'); ?></label>
                                <div class="input-group" style="display:flex;">
                                        ...
                                        <input id="contact_person_phone1" autocomplete="off" name="contact_person_phone1"  type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="" class="form-control"  value="<?php echo set_value('contact_person_phone'); ?>" />
                            <span class="text-danger"><?php echo form_error('contact_person_phone'); ?></span>
                                </div>
                        </div>  
                        <div class="form-group">
  ...
  function get(id) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                var countryCode3 = mobileno.substring(0, 4);

                var mobileno1 = result.contact_person_phone;
                var modifiedMobileno1 = mobileno1.substring(4);
                var countryCode4 = mobileno1.substring(0, 4);

                $('#supp_id').val(result.id);
                $('#name1').val(result.item_supplier);
                //$('#phone1').val(result.phone);
                $('#phone1').val(modifiedMobileno);
                $('#countryCode3').val(countryCode3);
                ...
                $('#contact_person_phone1').val(modifiedMobileno1);
                $('#countryCode4').val(countryCode4);
