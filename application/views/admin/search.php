                ...
                <div class="box box-info" style="padding:5px;">
                    ...
                    <div class="box-body table-responsive">
                        <form id="deleteForm" method="post">
                            ...
                            <div class="">
                                <button type="submit" class="btn btn-primary pull-right btn-sm mt10" onclick="multipleDeletePatient()" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> " autocomplete="off"><i class="fa fa-trash"></i> <?php echo $this->lang->line('delete') . " " . $this->lang->line('selected'); ?></button>
                            </div>

                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        <th><input type="checkbox" name="checkAll" autocomplete="off"></th>
                                        ...
                                        <!-- <th><?php echo 'Alternative' . " " . $this->lang->line('no'); ?></th>
                                        <th><?php echo 'TPA'; ?></th>
                                        <th><?php echo 'TPA' . " " . $this->lang->line('id'); ?></th>
                                        <th><?php echo 'TPA' . " " . 'Validity'; ?></th> -->
                                    ...
                                    ?>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><input class="chk2 enable_delete" type="checkbox" name="patient[]" value="<?php echo $report['id'] ?>" autocomplete="off"></td>
                                                    ...
                                                    <!-- <td><?php echo $report['alternative_no']; ?></td>
                                                    <td><?php echo $report['tpa']; ?></td>
                                                    <td><?php echo $report['tpa_id']; ?></td>
                                                    <td><?php echo $report['tpa_validity']; ?></td> -->
                                                  
                                                    <td><?php echo $report['address']; ?></td>
                                                    <td><?php echo $dead; ?></td>
                                                    <td class="">
                                                    <a data-toggle="" href="<?php echo base_url() ?>admin/admin/transfer_manually/<?php echo $report['id'] ?>" id="" class="btn btn-default btn-xs"  title="<?php echo $this->lang->line('transfer')." Manually"; ?>"><i class="fa fa-plus"></i></a>

                                                    <a href="#" onclick="printData('<?php echo $report['id'] ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('print'); ?>">
                                                     ...
                                                     <!--   <a href="#" data-toggle="modal" onclick="transferPatientData('<?php echo $report['id'] ?>')" data-target="" class="btn btn-default btn-xs"
                                                            title="<?php echo $this->lang->line('transfer'); ?>">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="row ptt10">
                                        ...
                                        <li>
                                                ...
                                                <li>
                                                    <b><?php echo $this->lang->line('national_identification_no') ?></b>
                                                    <span id="identity_number"></span>
                                                </li>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="row ptt10">
                                                ...
                                                <div class="col-sm-5" id="calculate">
                                                    <div class="form-group">
                                                        ...
                                                        <div style="clear: both;overflow: hidden;">
                                                            <input type="text" placeholder="<?php echo $this->lang->line('year') ?>" name="age" id="eage_year" value="" class="form-control" style="width: 43%; float: left;" readonly>
                                                            <input type="text" id="eage_month" placeholder="<?php echo $this->lang->line('month') ?>" name="month" value="" class="form-control" style="width: 53%;float: left; margin-left: 4px;" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label for="pwd"><?php echo $this->lang->line('mobile_no'); ?></label><small class="req"> *</small>
                                                <div class="input-group" style="display:flex;">
                                                    <div class="input-group-prepend">
                                                        <select id="ecountryCode" name="countryCode" class="form-control" style="padding: 0px;width: 58px;">
                                                            <option value="+965">+965</option>
                                                            <option value="+962">+962</option>
                                                        </select>
                                                    </div>
                                                    <input id="emobileno" autocomplete="off" name="emobileno" type="text" placeholder="" class="form-control" value="<?php echo set_value('mobileno'); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="email" placeholder="" id="eemail" value="<?php echo set_value('email'); ?>" name="email" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('national_identification_no'); ?></label>
                                                <input name="identification_number" id="eidentification_number" placeholder="" class="form-control" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="address"><?php echo 'TPA'; ?></label>
                                          

                                            <select name="tpa" id="etpa" class="form-control">
                                                            <option value=""><?php echo $this->lang->line('select') ?></option>
                                                            <?php foreach ($organisation as $key => $orgvalue) {
                                                            ?>
                                                                <option value="<?php echo $orgvalue["id"]; ?>" <?php if (set_value('tpa') == $orgvalue["id"]) echo "selected"; ?>><?php echo $orgvalue["organisation_name"]; ?></option>
                                                            <?php } ?>
                                                        </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="address"><?php echo 'TPA'." ".$this->lang->line('id'); ?></label>
                                            <input name="tpa_id" id="etpa_id" placeholder="" class="form-control" /><?php echo set_value('address'); ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="address"><?php echo 'TPA'." ".'Validity'; ?></label>
                                            <input name="tpa_validity" id="etpa_validity" placeholder="" class="form-control date" /><?php echo set_value('tpa_validity'); ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                    <div class="form-group">
                                            <label for="pwd"><?php echo 'Alternative'.' '.'No'; ?></label>
                                            <div class="input-group" style="display:flex;">
                                                <div class="input-group-prepend">
                                                    <select id="ecountryCode_altno" name="countryCode_altno" class="form-control" style="padding: 0px;width: 58px;">
                                                        <option value="+965">+965</option>
                                                        <option value="+962">+962</option>
                                                    </select>
                                                </div>
                                                <input id="ealternative_no" autocomplete="off" name="alternative_no" type="text" placeholder="" class="form-control" value="<?php echo set_value('alternative_no'); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                            </div>
                                        </div>
                                    </div>
                                        <div class="col-sm-6">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="box-title"> <?php echo $this->lang->line('transfer') . " " . $this->lang->line('patient');  ?></h4>
                <div class="row">
                    <div class="col-sm-4 col-xs-3">
                        <div class="form-group15">
            ...
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <form id="transferpatient" accept-charset="utf-8" action="<?php echo base_url() . "admin/Data_transfer/sendData" ?>" enctype="multipart/form-data" method="post">
                            <input class="" name="patientid" type="hidden" id="transferpatientid">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="pwd"><?php echo $this->lang->line('hospital'); ?></label>
                                        <select name="hospital_name" id="" class="form-control">
                                            <option value=""><?php echo $this->lang->line('select') ?></option>
                                            <option value="hospital2"><?php echo $this->lang->line('hospital') ."2"; ?></option>
                                            <option value="hospital3"><?php echo $this->lang->line('hospital') ."3"; ?></option>
                                            <option value="hospital4"><?php echo $this->lang->line('hospital') ."4"; ?></option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="box-footer">
                                        <div class="pull-right">
                                            <button type="submit" id="transferpatientbtn" data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-info pull-right"><?php echo $this->lang->line('transfer'); ?></button>
                                        </div>
                                    </div>
                                </div><!--./row-->
                            </div><!--./row-->
...
function printData(id) {
       // alert(id);
        ...
        $.ajax({
            url: base_url + 'admin/admin/printTransferManually/' + id,
            type: 'POST',
            data: {
                id: id,
                print: 'yes'
    ...
    // Create a new HTML document, include the same styles used on the page
    ...
    // Include custom CSS specific to your transfer form page
    frameDoc.document.write('<link rel="stylesheet" href="' + base_url + 'path/to/your/custom/css/transfer_manually.css">');  // Add your custom CSS file if needed
    frameDoc.document.write('</head>');
    ...
    function checkIfPrintDialogClosed() {
        if (isPrintDialogClosed) {
            ...
            setTimeout(checkIfPrintDialogClosed, 500);
        }
    }
    ...
    function transferPatientData(id) {


        $("#transferpatientid").val(id);
        holdModal('transferModal');
    ...
    function getpatientData(id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#identity_number").html(data.identity_number);
                $("#tpa").html(data.organisation_name);
                $("#tpa_id").html(data.tpa_id);
                $("#tpa_validity").html(data.tpa_validity);
                $("#barcodee").html(
    '<img class="" src="<?php echo base_url(); ?>uploads/barcode/' + data.id + '.png" id="" alt="User profile picture" width="66" height="32">'
);
$("#qrcodee").html(
    '<img class="" src="<?php echo base_url(); ?>uploads/qrcode/' + data.id + '.png" id="" alt="User profile picture"width="60" height="60">'
);


               
                $("#alt_no").html(data.alternative_no);
...
//alert(id);
        $.ajax({
            url: '<?php echo base_url(); ?>admin/patient/patientvisit',
            type: "POST",
            data: {
                id: id
            },
...
//alert(data);
    ...
    function editRecord(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var alternative_no = data.alternative_no;
                var modifiedalternative_no = alternative_no.substring(4);
                var countryCode_altno = alternative_no.substring(0, 4);

             //   alert(countryCode_altno);

                $("#eupdateid").val(data.id);
                $("#ename").val(data.patient_name);
                $("#eguardian_name").val(data.guardian_name);
                $("#emobileno").val(modifiedMobileno);
                $("#ecountryCode").val(countryCode);
                $("#eemail").val(data.email);
                $("#eaddress").val(data.address);
                $("#ealternative_no").val(modifiedalternative_no);
                $("#ecountryCode_altno").val(countryCode_altno);
                $("#eidentification_number").val(data.identity_number);

                // $("#etpa").val(data.tpa);
                $("#etpa_id").val(data.tpa_id);
                $("#etpa_validity").val(data.tpa_validity); 
                ...
                $('select[id="etpa"] option[value="' + data.tpa + '"]').attr("selected", "selected");
                $("#myModal").modal('hide');
                holdModal('editModal');
    ...
    // Check all and delete function
    $("input[name='checkAll']").click(function() {
        $("input[name='patient[]']").not(this).prop('checked', this.checked);
    });


    function multipleDeletePatient() {
        var selectedIds = [];
        $("input[name='patient[]']:checked").each(function() {
            selectedIds.push($(this).val());
        });

        if (selectedIds.length === 0) {
            alert("<?php echo $this->lang->line('no_records_selected'); ?>");
            return;
        }

        if (confirm("<?php echo $this->lang->line('are_you_sure_wont_to_delete'); ?>")) {
            $.ajax({
                url: '<?php echo base_url(); ?>admin/patient/multiplePatientdlt',
                type: "POST",
                data: {
    ...
    function exportToExcelDirectly() {
    // Get the table's HTML content
    var tableContent = document.getElementById('visit_report').innerHTML;

    // Create the Excel-compatible HTML structure
    var excelFile = "<html xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:x='urn:schemas-microsoft-com:office:excel' xmlns='http://www.w3.org/TR/REC-html40'>" +
        "<head><meta charset='utf-8'><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name>Sheet1</x:Name>" +
        "<x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml></head><body>" +
        "<table>" + tableContent + "</table></body></html>";
    ...
    link.href = 'data:application/vnd.ms-excel;base64,' + base64(excelFile);
    link.download = 'PatientBillReport.xls'; // Name of the downloaded file
