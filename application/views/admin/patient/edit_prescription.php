    ...
    function geteditMedicineName(id, selectid = '') {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $("#editsearch-query" + id).html("<option value=''><?php echo $this->lang->line('select') ?></option>");
    ...
    function geteditMedicineDosage(id, selectid = '') {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $("#editsearch-dosage" + id).html("<option value=''><?php echo $this->lang->line('select') ?></option>");
