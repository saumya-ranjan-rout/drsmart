                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('total_admit_days'); ?></th>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php if (!empty($report['age'])) {
                                                        echo $report['age'] . " " . $this->lang->line("years") . " ";
                                                    }
                                                    if (!empty($report['month'])) {
                                                        echo $report['month'] . " " . $this->lang->line("month");
                                                    } ?>
                                                </td>
                                                ...
                                                <td><?php echo date($this->customlib->getSchoolDateFormat(), strtotime($report['discharge_date'])) ?></td>
                                                <td>
                                                    <?php
                                                    // Convert the dates to DateTime objects                                                   
                                                    $admissionDate = new DateTime(date('Y-m-d', strtotime($report['date'])));
                                                    // $dischargeDate = new DateTime($report['discharge_date']);
                                                    $dischargeDate = new DateTime(date('Y-m-d', strtotime($report['discharge_date'])));

                                                    // Calculate the difference
                                                    $interval = $admissionDate->diff($dischargeDate);

                                                    // Display the result
                                                    $days = $interval->days; // Total days difference
                                                    ?>
                                                    <?php echo $days; ?>
                                                </td>
                                ...
                                <tr class="box box-solid total-bg">
                                    <td class="text-right" colspan='21'><?php echo $this->lang->line('total') . " :" . $currency_symbol . $total; ?>
                                    </td>
                                </tr>
                            <?php } ?>
                            </table>
