...
<script type="text/javascript">
    ...
    function geteditMedicineName(id, selectid = '', dosage = '') {
        ...
        $("#editsearch-query" + id).html("<option value=''><?php echo $this->lang->line('loading') ?></option>");
    ...
    function geteditMedicineDosage(id, selectid = '') {
        ...
        var arr = category_selected.split('-');
        var category_set = arr[0];
        // alert("category_selected:"+category_selected);

        // alert(category_set);
        $("#editsearch-dosage" + id).html("<option value=''><?php echo $this->lang->line('loading') ?></option>");
...
<div class="row">
    ...
    <?php echo $this->lang->line('medicine'); ?></label>  -->
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <!-- <label><?php echo $this->lang->line('dosage'); ?></label>  -->
                                                <!-- <input type="text" class="form-control" value="<?php //echo $value['dosage']   
                                                                                                    ?>" name="dosage[]" id="report_document" /> -->
