            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div>
                            <p><?php echo "1. ". $this->lang->line('csv_format_instructions'); ?></p>
                            <p><?php echo "2. ". $this->lang->line('gender_instruction'); ?></p>
                            <p><?php echo "3. ". $this->lang->line('blood_group_instruction'); ?></p>
                            <p><?php echo "4. ". $this->lang->line('age_instruction'); ?></p>
                            <p><?php echo "5. ". $this->lang->line('marital_status_instruction'); ?></p>
                        </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    foreach ($fields as $key => $value) {
                                        ...
                                        } else if ($value == 'identity_number') {
                                            $value = $this->lang->line("national_identification_number");
                                        } else {
