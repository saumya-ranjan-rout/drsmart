                ...
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            ...
                            <td align="right"><h5>Appointment <?php echo $this->lang->line('date') . " : " ?><?php
...
<!--          <th width="25%" class=""><?php echo $this->lang->line('payment') . " " . $this->lang->line('mode'); ?></th>
                        ...
                        <tr>
                            ...
                            <td width="25%"><?php echo $result["payment_mode"] ?></td> 
                            <th width="25%"></th>
                            <td width="25%"></td> 
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="25%"><?php echo $result["cheque_no"] ?></td> 
                            <th width="25%"></th>
                            <td width="25%"></td> 
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="25%"><?php echo $result["cheque_date"] ?></td> 
                            <th width="25%"></th>
                            <td width="25%"></td> 
                        </tr>
                        <?php } ?>
