                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group15">
                            <div>
                                <select onchange="get_PatientDetails(this.value)" class="form-control select2"
                                    <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div><select name='consultant_doctor' id="consultant_doctor" onchange="get_Charges(this.value)" class="form-control select2"
                                                        <?php
                                                        if ($disable_option == true) {
                                                            echo "disabled";
                                                        }
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('applied') . " " . $this->lang->line('charge') . " (" . $currency_symbol . ")" ?></label><small class="req"> *</small><input type="text" name="amount" id="apply_charge" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="payment_mode" class="form-control" onchange="showPaymentByMode(this.value)">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <select onchange="get_Chargesrevisit(this.value)" class="form-control"
                                                        <?php
                                                        if ($disable_option == true) {
                                                            echo "disabled";
                                                        }
...
<script>
    $(document).ready(function() {
        var selectedDoctorId = $('#consultant_doctor').val();
        if (selectedDoctorId) {
            get_Charges(selectedDoctorId);
        }
    });
</script>
<script>
    // Reload page when modal is closed
    $('#revisitModal').on('hidden.bs.modal', function() {
