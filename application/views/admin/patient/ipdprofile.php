                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mb0 font13">
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="bozerotop"></th>
                                        <td class="bozerotop">
                                        </td>
                                        <th class="bozerotop"><?php echo $this->lang->line('hospital') . " " . $this->lang->line('department'); ?></th>
                                        <td class="bozerotop"><?php echo $result['department_name'] ?>
                                        </td>
                                    </tr>
                                    <?php if ($result['ipd_discharge'] != 'no') { ?>
                                        <tr>
                                            <th class="bozerotop"><?php echo $this->lang->line('discharged') . " " . $this->lang->line('date'); ?></th>
                                            <td class="bozerotop"><?php echo date($this->customlib->getSchoolDateFormat(), strtotime($bill_info['discharge_date'])) ?><?php //echo date($this->customlib->getSchoolDateFormat($bill_info['discharge_date'])); 
                                                                                                                                                                        ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                ...
                <div class="box border0">
                    ...
                    <div class="nav-tabs-custom border0" id="tabs">
                        <ul class="nav nav-tabs">
                            ...
                            <?php } ?>
                            <?php if ($this->rbac->hasPrivilege('ipd_nurse_note', 'can_view')) { ?>
                                <li>
                                    <a href="#nurse_notes" data-toggle="tab" aria-expanded="true"><i class="fas fa-sticky-note"></i> <?php echo $this->lang->line('nurse_notes'); ?></a>
                                </li>
                            <?php } ?>
                            ...
                            if ($this->rbac->hasPrivilege('bed_status', 'can_view')) { ?>
                                <li>
                                    <a href="#bed_history" data-toggle="tab" aria-expanded="true"><i class="fas fa-procedures"></i> <?php echo $this->lang->line('bed_history'); ?>
                                    </a>
                                </li>
                                <?php }

                            if ($result['discharge_status'] == 'approved') {
                            ...
                            <?php if ($this->rbac->hasPrivilege('ipd_treatment_history', 'can_view')) { ?>
                                <li>
                                    <a href="#treatment_history" class="treatment_history" data-toggle="tab" aria-expanded="true"><i class="fas fa-hourglass-half"></i> <?php echo $this->lang->line('treatment_history'); ?></a>
                                </li>
                            <?php } ?>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="consultant_register">
                                ...
                                ?>
                                        <div class="text-right">
                                            <a href="#" class="btn btn-sm btn-primary dropdown-toggle float-end" onclick="holdModal('add_instruction')" data-toggle="modal"><i class="fas fa-plus"></i> <?php echo $this->lang->line('add') . " " . $this->lang->line('consultant') . " " . $this->lang->line('instruction'); ?></a>
                                        </div><!--./impbtnview-->
                                <?php
                                    }
                                }
                            ...
                            <div class="tab-pane" id="nurse_notes">
                                <?php if ($this->rbac->hasPrivilege('ipd_nurse_note', 'can_add')) { ?>
                                    <!-- <div class="impbtnview"> -->
                                    <div class="text-right">

                                        <a href="#" class="btn btn-sm btn-primary dropdown-toggle" onclick="holdModal('myNurseNoteModal')" data-toggle='modal'><i class="fa fa-plus"></i> <?php echo $this->lang->line('add') . " " . $this->lang->line('nurse') . " " . $this->lang->line('note'); ?></a>

                                    </div><!--./impbtnview-->
                                <?php } ?>
                                <div class="download_label"><?php echo $result['patient_name'] . " " . $this->lang->line('ipd') . " " . $this->lang->line('details'); ?></div>
                                <div class="timeline-header no-border">
                                    <div id="nursenote_list">
                                        <?php if (empty($nursenote_list)) { ?>
                                            <br />
                                            <div class="alert alert-info"><?php echo $this->lang->line('no_record_found'); ?></div>
                                        <?php } else { ?>
                                            <ul class="timeline timeline-inverse">
                                                <?php
                                                foreach ($nursenote_list as $key => $value) {
                                                ?>
                                                    <li class="time-label">
                                                        <span class="bg-blue">
                                                            <?php echo date($this->customlib->getSchoolDateFormat(true, true), strtotime($value['nurse_note_date'])) ?>
                                                        </span>
                                                    </li>
                                                    <li>
                                                        <i class="fa fa-list-alt bg-blue"></i>
                                                        <div class="timeline-item">
                                                            <?php if ($this->rbac->hasPrivilege('ipd_nurse_note', 'can_delete')) { ?>
                                                                <span class="time"><a class="defaults-c text-right" data-toggle="tooltip" title="" onclick="delete_nursenote('<?php echo $value['id']; ?>')" data-original-title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash"></i></a></span>
                                                            <?php } ?>

                                                            <?php if ($this->rbac->hasPrivilege('ipd_nurse_note', 'can_add')) { ?>
                                                                <span class="time">
                                                                    <a onclick="addcommentNursenote('<?php echo $value['id']; ?>')" class="defaults-c text-right" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('comment'); ?>">
                                                                        <i class="fa fa-comment"></i>
                                                                    </a>
                                                                </span>
                                                            <?php } ?>

                                                            <?php if ($this->rbac->hasPrivilege('ipd_nurse_note', 'can_edit')) { ?>
                                                                <span class="time"><a onclick="editNursenote('<?php echo $value['id']; ?>')" class="defaults-c text-right" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                                        <i class="fa fa-pencil"></i>
                                                                    </a></span>
                                                            <?php } ?>

                                                            <h3 class="timeline-header text-aqua"> <?php echo $value['nursename'] . " " . $value['nursesurname']; ?> </h3>
                                                            <div class="timeline-body"><b><?php echo $this->lang->line('note'); ?></b><br>
                                                                <?php echo $value['note']; ?>
                                                            </div>
                                                            <div class="timeline-body"><b><?php echo $this->lang->line('comment'); ?></b><br>
                                                                <?php echo $value['comment']; ?>
                                                            </div>

                                                            <?php if (!empty($value['comments'])) { // Check if there are comments 
                                                            ?>
                                                                <div class="timeline-body">
                                                                    <?php foreach ($value['comments'] as $comment) { ?>
                                                                        <div>
                                                                            <?php echo $comment['comment_staff'];
                                                                            ?>
                                                                            <a class="btn btn-default btn-xs"
                                                                                data-toggle="tooltip" title=""
                                                                                onclick="delete_comment_nursenote('<?php echo $comment['id']; ?>')"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover example">
                                            <thead>
                                                ...
                                                <th><?php echo $this->lang->line('prescription'); ?><?php echo $this->lang->line('no'); ?></th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $prescription_value["pres_no"] ?></td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover example">
                                        <thead>
                                            ...
                                            <?php //if ($this->rbac->hasPrivilege('ipd diagnosis', 'can_edit') || $this->rbac->hasPrivilege('ipd diagnosis', 'can_delete')) { 
                                            ?>
                                            <th class="text-right"><?php echo $this->lang->line('action'); ?></th>
                                            <?php //} 
                                            ?>
                            ...
                            <div class="tab-pane" id="bed_history">
                                <div class="download_label"><?php echo "Bed History"; ?></div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover example">
                                        <thead>
                                            ...
                                            <th><?php echo $this->lang->line('active') . " " . $this->lang->line('bed'); ?></th>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            if (!empty($bed_history)) {
                                                ...
                                                foreach ($bed_history as $bed) {
                                                    $status = $bed['discharged'];
                                                    if ($status == "no") {
                                                        $active = "Yes";
                                                    } else {
                                                        $active = "No";
                                                    }
                                                    if ($bed["discharged_date"] != "0000-00-00") {
                                                        $discharged_date = date($this->customlib->getSchoolDateFormat(true, false), strtotime($bed['discharged_date']));
                                                    }
                                            ?>
                                                    <tr>
                                                        <td style="text-transform: capitalize;"><?php echo $bed["bedgname"]; ?></td>
                                                        <td style="text-transform: capitalize;"><?php echo $bed["bedname"]; ?></td>
                                                        <td><?php echo date($this->customlib->getSchoolDateFormat(true, true), strtotime($bed['date'])); ?></td>
                                                        <td><?php echo $discharged_date; ?></td>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <?php //if ($this->rbac->hasPrivilege('charges', 'can_edit')) { 
                                                            ?>

                                                            <a onclick="editIpdCharges('<?php echo $charge['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>
                                                            <?php //} 
                                                            ?>
                                                            ...
                                                            <a onclick="printIpdCharges('<?php echo $charge['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('print'); ?>">
                                                    ...
                                                    <?php if ($result['ipd_discharge'] != 'paid') { ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right ipdbilltable">
                                                                <input type="number" id="discount_percent" name="discount_percent" style="width: 30%; float: right" class="form-control" oninput="validateNumber(this)">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="text-right ipdbilltable">
                                                                ...
                                                                <input type="text" id="discount" value="<?php
                                                                                                        ...
                                                                                                        ?>" name="discount" style="width: 30%; float: right" class="form-control" readonly>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="text-right ipdbilltable"><input type="text" id="other_charge" value="<?php
                                                                                                                                            ...
                                                                                                                                            ?>" name="other_charge" style="width: 30%; float: right" class="form-control" oninput="validateNumber(this)"></td>
                                                        </tr>
                                                        <tr>
                                                            <th><?php echo $this->lang->line('tax') . "(%)"; ?></th>
                                                            <td class="text-right ipdbilltable">
                                                                <input type="number" id="tax_percent" name="tax_percent" style="width: 30%; float: right" class="form-control" oninput="validateNumber(this)">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="text-right ipdbilltable"><input type="text" name="tax" value="<?php
                                                                                                                                        ...
                                                                                                                                        ?>" id="tax" style="width: 30%; float: right" class="form-control" readonly></td>
                                                        </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-transform: capitalize;">
                                                            ...
                                                            if ($payment["payment_mode"] == "Cheque") {
                                                                ...
                                                                echo "Cheque No: " . $payment["cheque_no"] . "<br>";
                                                                echo "Cheque Date: " . date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($payment['cheque_date']));
                                                            } else {
                                                        ...
                                                        <?php if ($this->rbac->hasPrivilege('payment', 'can_delete')) { ?>
                                                            <td class="text-right">
                                                                <?php if (!empty($payment["document"])) { ?>
                                                                    <!-- onclick="delte_record('<?php echo base_url(); ?>admin/payment/download/<?php echo $payment["document"]; ?>', '<?php echo $this->lang->line('delete_message'); ?>')" -->
                                                                    <a href="<?php echo base_url() . "admin/payment/download/" . $payment["document"] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
                                                                        <i class="fa fa-download"></i>
                                                                    </a>
                                                                <?php } ?>
                                                                <a onclick="editIpdPayment('<?php echo $payment['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <?php if ($this->rbac->hasPrivilege('payment', 'can_delete')) { ?>
                                                                ...
                                                                <?php } ?>
                                                                <a onclick="printIpdPayment('<?php echo $payment['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('print'); ?>">
                                                                    <i class="fa fa-print"></i>
                                                                </a>
                            ...
                            <div class="tab-pane" id="treatment_history">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover example">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?php echo $treatment_history["ipd_no"] ?></td>
                                                <td><?php echo $treatment_history["symptoms"] ?></td>
                                                <td><?php echo $treatment_history["doctorname"] . " " . $treatment_history["surname"] ?></td>
                                                <td class="text-right"><?php echo $treatment_history['bed_name'] . " - " . $treatment_history['bedgroup_name'] . " - " . $treatment_history['floor_name'] ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                ...
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('report') . " " . $this->lang->line('date') ?> </label><input type="text" class="form-control datee" name="report_date" />
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
...
<div class="modal fade" id="myNurseNoteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"> <?php echo $this->lang->line('add') . " " . $this->lang->line('nurse') . " " . $this->lang->line('note'); ?></h4>
            </div>
            <form id="add_nursenote" accept-charset="utf-8" enctype="multipart/form-data" method="post" class="">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nurse_note_date" name="nurse_note_date" class="form-control datetimee">
                                    <span class="text-danger"><?php echo form_error('nurse_note_date'); ?></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('nurse'); ?></label><small class="req"> *</small>
                                    <div>
                                        <select class="form-control select2" <?php
                                                                                if ((isset($disable_option)) && ($disable_option == true)) {
                                                                                    echo 'disabled';
                                                                                }
                                                                                ?> name='nurse' style="width:100%">
                                            <option value="<?php echo set_value('nurse'); ?>"><?php echo $this->lang->line('select') ?></option>
                                            <?php foreach ($nurse as $nkey => $nvalue) {
                                            ?>
                                                <option value="<?php echo $nvalue["id"]; ?>" <?php
                                                                                                if ($nurse_select == $nvalue['id']) {
                                                                                                    echo 'selected';
                                                                                                }
                                                                                                ?>><?php echo $nvalue["name"] . " " . $nvalue["surname"] ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <?php if ((isset($disable_option)) && ($disable_option == true)) { ?>
                                        <input type="hidden" name="nurse" value="<?php echo $nurse_select; ?>">
                                    <?php } ?>
                                    <span class="text-danger"><?php echo form_error('nurse'); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="note" name="note" placeholder="" class="form-control"></textarea>
                                    <span class="text-danger"><?php echo form_error('note'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('comment'); ?></label><small class="req"> *</small>
                                    <textarea id="comment" name="comment" placeholder="" class="form-control"></textarea>
                ...
                <div class="box-footer">
                    <button type="submit" id="add_nursenotebtn" data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-info pull-right"><?php echo $this->lang->line('save'); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<!-- Edit Nurse Note Modal -->
<div class="modal fade" id="myNurseNoteEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"> <?php echo $this->lang->line('edit') . " " . $this->lang->line('nurse') . " " . $this->lang->line('note'); ?></h4>
            </div>
            <form id="edit_nursenote" accept-charset="utf-8" enctype="multipart/form-data" method="post" class="">
                    ...
                    <div class="ptt10">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="nurse_note_id" id="enurse_note_id" value="">
                                    <input type="text" id="enurse_note_date" name="nurse_note_date" class="form-control datetimee" value="<?php echo set_value('enurse_note_date'); ?>">
                                    <span class="text-danger"><?php echo form_error('nurse_note_date'); ?></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select class="form-control select2" <?php
                                                                                ...
                                                                                ?> name='nurse' style="width:100%" id="nurse">
                                            <option value="<?php echo set_value('nurse'); ?>"><?php echo $this->lang->line('select') ?></option>
                                            <?php foreach ($nurse as $nkey => $nvalue) {
                                            ?>
                                                <option value="<?php echo $nvalue["id"]; ?>"><?php echo $nvalue["name"] . " " . $nvalue["surname"] ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <span class="text-danger"><?php echo form_error('nurse'); ?></span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('note'); ?></label><small class="req"> *</small>
                                    <textarea id="enote" name="note" placeholder="" class="form-control"></textarea>
                                    <span class="text-danger"><?php echo form_error('note'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('comment'); ?></label><small class="req"> *</small>
                                    <textarea id="ecomment" name="comment" placeholder="" class="form-control"></textarea>
                                    <span class="text-danger"><?php echo form_error('comment'); ?></span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="box-footer">
                    <div class="pull-right">
                        <button type="submit" data-loading-text="<?php echo $this->lang->line('processing') ?>" id="edit_nursenotebtn" class="btn btn-info pull-right"><?php echo $this->lang->line('save'); ?></button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-content modal-media-content mx-2">
            ...
            <form id="comment_nursenote" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="row">
                            <input type="hidden" name="nurse_note_id" id="nurse_noteid">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <span class="text-danger"><?php echo form_error('comment_staff'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <div class="pull-right">
                        <button type="submit" data-loading-text="Processing..." id="comment_nursenotebtn"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="report_date" class="form-control datee" id="ereportdate" />
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="row">
                                <table class="table mb0 table-striped table-bordered examples">
                                    ...
                                    <tr>
                                        ...
                                        <th width="15%"><?php echo $this->lang->line('previous_medical_issue'); ?></th>
                                        <td width="35%"><span id="pmi"></span>
                                        </td>
                                    </tr>
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <form id="add_payment" accept-charset="utf-8" method="post" class="ptt10" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('payment') . " " . $this->lang->line('date'); ?></label><small class="req"> *</small>
                                        <input type="text" name="payment_date" id="date" class="form-control datee">
                                        <span class="text-danger"><?php echo form_error('apply_charge'); ?></span>
                                    </div>
                                </div>
...
<!-- Edit Payment Modal-->
<div class="modal fade" id="myEditPaymentModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"><?php echo $this->lang->line('edit') . " " . $this->lang->line('payment'); ?></h4>
            </div>
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <form id="update_payment" accept-charset="utf-8" method="post" class="ptt10">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('amount') . " (" . $currency_symbol . ")"; ?></label><small class="req"> *</small>
                                        <input type="text" name="eamount" id="eamount" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                        <input type="hidden" name="epatient_id" id="epayment_patient_id" class="form-control" value="<?php echo $result['id'] ?>">
                                        <input type="hidden" name="last_paid" id="last_paid" class="form-control">
                                        <input type="hidden" name="eipdid" value="<?php echo $ipdid ?>">
                                        <input type="hidden" name="etotal" id="etotal" class="form-control">
                                        <input type="hidden" name="epid" id="epid" class="form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('payment') . " " . $this->lang->line('mode'); ?></label>
                                        <select class="form-control" name="epayment_mode" id="epayment_mode" onchange="showPaymentByMode(this.value)">
                                            <?php foreach ($payment_mode as $key => $value) {
                                            ?>
                                                <option value="<?php echo $key ?>"
                                                    <?php
                                ...
                                <div class="showhid">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('cheque') . " " . $this->lang->line('no'); ?></label><small class="req"> *</small>
                                            <input type="text" name="echeque_no" id="echeque_no" class="form-control">
                                            <span class="text-danger"><?php echo form_error('cheque_no'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('cheque') . " " . $this->lang->line('date'); ?></label><small class="req"> *</small>
                                            <input type="text" name="echeque_date" id="echeque_date" class="form-control date">
                                            <span class="text-danger"><?php echo form_error('cheque_date'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('payment') . " " . $this->lang->line('date'); ?></label><small class="req"> *</small>
                                        <input type="text" name="epayment_date" id="edate" class="form-control datee">
                                        <span class="text-danger"><?php echo form_error('epayment_date'); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('note'); ?></label>
                                        <input type="text" name="enote" id="enote" class="form-control" />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="box-footer">
                                    <button type="submit" id="update_paymentbtn" data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-info pull-right"><?php echo $this->lang->line('save'); ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input id="charge_date" name="date" placeholder="" type="text" class="form-control datee" />
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('applied') . " " . $this->lang->line('charge') . " (" . $currency_symbol . ")" ?></label><small class="req"> *</small><input type="text" name="apply_charge" id="apply_charge" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" readonly>
                                        <span class="text-danger"><?php echo form_error('apply_charge'); ?></span>
                                    </div>
                                </div>
                            </div>
...
<!-- edit charge modal -->
<div class="modal fade" id="myEditChargesModal" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"><?php echo $this->lang->line('edit') . " " . $this->lang->line('charges') ?></h4>
            </div>
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <form id="update_charges" accept-charset="utf-8" method="post" class="ptt10">
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('date'); ?></label> <small class="req"> *</small>
                                        <input id="echarge_date" name="edate" placeholder="" type="text" class="form-control datee" />
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select name="echarge_type" onchange="getcharge_category(this.value)" class="form-control" id="echarge_type">
                                            <option value=""><?php echo $this->lang->line('select') ?></option>
                                            <?php foreach ($charge_type as $key => $value) {
                                            ?>
                                                <option value="<?php echo $key ?>">
                                        ...
                                        <span class="text-danger"><?php echo form_error('echarge_type'); ?></span>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('charge') . " " . $this->lang->line('category') ?></label><small class="req"> *</small>
                                        <select name="echarge_category" id="echarge_category" style="width: 100%" class="form-control select2" onchange="getchargecode(this.value)">
                                            <option value=""><?php echo $this->lang->line('select') ?></option>
                                        </select>
                                        <span class="text-danger"><?php echo form_error('echarge_category'); ?></span>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('code') ?></label><small class="req"> *</small>
                                        <select name="ecode" id="ecode" style="width: 100%" class="form-control select2" onchange="get_Charges(this.value, '<?php echo $result['organisation'] ?>')">
                                            <option value=""><?php echo $this->lang->line('select') ?></option>
                                        </select>
                                        <span class="text-danger"><?php echo form_error('ecode'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('standard') . " " . $this->lang->line('charge') . " (" . $currency_symbol . ")" ?></label>
                                        <input type="text" readonly name="estandard_charge" id="estandard_charge" class="form-control" value="<?php echo set_value('standard_charge'); ?>">

                                        <input type="hidden" name="echarge_id" id="echarge_id">
                                        <input type="hidden" name="eorg_id" id="eorg_id">
                                        <input type="hidden" name="uid" id="uid" value="">
                                        <span class="text-danger"><?php echo form_error('estandard_charge'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('organisation') . " " . $this->lang->line('charge') . " (" . $currency_symbol . ")" ?></label>
                                        <input type="text" readonly name="eschedule_charge" id="eschedule_charge" placeholder="" class="form-control" value="<?php echo set_value('schedule_charge'); ?>">
                                        <span class="text-danger"><?php echo form_error('eschedule_charge'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('applied') . " " . $this->lang->line('charge') . " (" . $currency_symbol . ")" ?></label><small class="req"> *</small><input type="text" name="eapply_charge" id="eapply_charge" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" readonly>
                                        <span class="text-danger"><?php echo form_error('eapply_charge'); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="box-footer">
                                    <button type="submit" id="update_chargesbtn" data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-info pull-right"><?php echo $this->lang->line('save') ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <div class="row row-eq">
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                    ...
                                    <div class="ptt10">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label><?php echo $this->lang->line('previous_medical_issue'); ?></label>
                                                    <textarea class="form-control" id="epmi" name="pmi"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-eq ptt10">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="exampleInputFile"><?php echo $this->lang->line('hospital') . " " . $this->lang->line('department'); ?></label>
                                                <div>
                                                    <select class="form-control" name='hospital_department' id='ehospital_departments'>
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                        <?php foreach ($hospital_deapartment_list as $key => $dept) {
                                                        ?>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="credits_limits" value="<?php echo set_value('credit_limit'); ?>" name="credit_limit" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="exampleInputFile">
                                                    <?php echo $this->lang->line('bed') . " " . $this->lang->line('group'); ?></label><small class="req"> *</small>
                                                <div>
                                                ...
                                                <span class="text-danger"><?php echo form_error('bed_group_id'); ?></span>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped table-bordered table-hover" id="constableID">
                                    ...
                                    <tr id="row0">
                                        <td><input type="text" id="date0"name="date[]" value="" class="form-control"></td>
                                        ...
                                        <td><input type="text" id="insdate0" name="insdate[]" value="" class="form-control" readonly>
                                            <input type="hidden" name="ipdid" value="<?php echo $ipdid ?>">
                                        </td>
...
<script type="text/javascript">
    ...
    function getRecord(id, ipdid) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#pmi").html(data.pre_medical_issue);
                holdModal('viewModal');
            },
        });
    }
    ...
    function getEditRecord(id, ipdid) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('select[id="ehospital_departments"] option[value="' + data.hospital_department + '"]').attr("selected", "selected");
    ...
    function getBed(bed_group, bed = '', active, htmlid = 'bed_nos') {
        ...
        var div_data = "";
        $('#' + htmlid).html("<option value=''><?php echo $this->lang->line('loading') ?></option>");
        $("#" + htmlid).select2("val", '');
        $.ajax({
    ...
    function getMedicineName(id) {
        ...
        $("#search-query" + id).html("<option value=''><?php echo $this->lang->line('loading') ?></option>");
    ...
    function getMedicineDosage(id) {
        ...
        $("#search-dosage" + id).html("<option value=''><?php echo $this->lang->line('loading') ?></option>");
    ...
    function getcharge_category(id, selectid) {
        var div_data = "";
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $('#echarge_category').html("<option value=''><?php echo $this->lang->line('select') ?></option>");
                $('#echarge_category').append(div_data);
                $("#echarge_category").select2("val", selectid);
            }
        });
    }
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res) {
                    ...
                    $('#eschedule_charge').val(res.org_charge);
                    $('#echarge_id').val(res.id);
                    $('#eorg_id').val(res.org_charge_id);

                    if (res.org_charge === null || res.org_charge === "" || res.org_charge === undefined || res.org_charge === "0") {
                        $('#apply_charge').val(res.standard_charge);
                        $('#eapply_charge').val(res.standard_charge);
                    } else {
                        $('#apply_charge').val(res.org_charge);
                        $('#eapply_charge').val(res.org_charge);
                    }
    ...
    function getchargecode(charge_category, ecode) {
        var div_data = "";
        $('#code').html("<option value=''><?php echo $this->lang->line('loading') ?></option>");
        $("#code").select2("val", '');
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $('#ecode').html("<option value=''><?php echo $this->lang->line('select') ?></option>");
                $('#ecode').append(div_data);
                $("#ecode").select2("val", ecode);
    ...
    function calculate() {
        ...
        $("#printBill").show();
        if (net_amount != 0) {
            $("#save_button").show().prop('disabled', true);
        } else {
            $("#save_button").show().prop('disabled', false);
        }
        // $("#save_button").show();
        // $("#printBill").show();
    }
    ...
    // Initialize the date picker for the newly added row
    $('#date' + id).datepicker({
        format: '<?php echo $result = strtr($this->customlib->getSchoolDateFormat(), ['d' => 'dd', 'm' => 'mm', 'Y' => 'yyyy',]) ?>',
        startDate: '+0d', // Disable past dates
        todayHighlight: true, // Highlight today's date
        autoclose: true
    }).on('changeDate', function(selected) {
        var selectedDate = new Date(selected.date.valueOf());
        $('#insdate' + id).datepicker('setStartDate', selectedDate).prop('disabled', false); // Enable and set follow-up date start after selected date

        // Clear the instruction date whenever applied date is changed
        $('#insdate' + id).val(''); 

        // Clear the instruction date if it's less than the selected date
        var insdateField = $('#insdate' + id);
        var insdateValue = insdateField.datepicker('getDate');

        if (insdateValue && insdateValue <= selectedDate) {
            alert("The instruction date must be greater than the applied date.");
            insdateField.val(''); // Clear the invalid instruction date
        }
    });

    $('#insdate' + id).datepicker({
        format: '<?php echo $result = strtr($this->customlib->getSchoolDateFormat(), ['d' => 'dd', 'm' => 'mm', 'Y' => 'yyyy',]) ?>',
        autoclose: true,
        todayHighlight: true, // Highlight today's date
        startDate: '+0d', // Disable past dates
    }).on('changeDate', function(selected) {
        var insdateValue = new Date(selected.date.valueOf());
        var dateField = $('#date' + id);
        var appliedDateValue = dateField.datepicker('getDate');

        // Check if the applied date is selected
        if (appliedDateValue == 'Invalid Date') {
            alert("Please select the applied date first.");
            $(this).val(''); // Clear the instruction date if no applied date is selected
            return;
        }

        // Check if instruction date is less than applied date
        if (insdateValue < appliedDateValue) {
            alert("The instruction date must be greater than the applied date.");
            $(this).val(''); // Clear invalid instruction date
        }
    });
}
...
$(document).ready(function () {
    // Initialize datepicker for the first row
    $('#date0').datepicker({
        format: '<?php echo $result = strtr($this->customlib->getSchoolDateFormat(), ['d' => 'dd', 'm' => 'mm', 'Y' => 'yyyy',]) ?>',
        startDate: '+0d', // Disable past dates
        todayHighlight: true, // Highlight today's date
        ...
        var selectedDate = new Date(selected.date.valueOf());
        $('#insdate0').datepicker('setStartDate', selectedDate).prop('disabled', false); // Enable and set follow-up date start after selected date
    ...
    $('#insdate0').datepicker({
        ...
        var insdateValue = new Date(selected.date.valueOf());
        var appliedDateValue = $('#date0').datepicker('getDate');
...
<script type="text/javascript">
    ...
    function printIpdCharges(id) {

        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'admin/charges/getIpdCharges/' + id,
            type: 'POST',
            data: {
                payslipid: id,
                print: 'yes'
    ...
    function printIpdPayment(id) {

        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'admin/payment/getIpdPayments/' + id,
            type: 'POST',
            data: {
                payslipid: id,
                print: 'yes'
    ...
    //below code avoid disappearing the date value
    $(document).ready(function() {
        var date_format = 'dd-mm-yyyy'; // Change 'datetime_format' to 'date_format'
        $('.date_x').datepicker({
            format: date_format, // Use 'date_format' here
            endDate: new Date(), // Restrict future dates
            autoclose: true, // This ensures the datepicker closes automatically after date selection
            todayHighlight: true,
            // todayHighlight: false,
            clearBtn: true
        }).on('show', function(e) {
            // Store the current date before showing the datepicker
            $(this).data('stickyDate', $(this).datepicker('getFormattedDate'));
        }).on('changeDate', function(e) {
            // This will update the date if a new date is selected
            var selectedDate = $(this).val();
            var newDate = e.format(date_format);

            if (selectedDate !== newDate) {
                $(this).datepicker('update', newDate);
            }
        }).on('hide', function(e) {
            // If the user clicks the same date, restore the previous value
            var stickyDate = $(this).data('stickyDate');
            if (!$(this).val() && stickyDate) {
                $(this).datepicker('update', stickyDate);
            }
        });
    });

    function validateNumber(input) {
        // Replace non-numeric characters except the first dot
    ...
    $(document).ready(function(e) {
        ...
        $("body").delegate(".datetimee", "focusin", function() {
            $(this).datetimepicker({
                format: datetime_format,
    ...
    function editIpdCharges(id) {
        // alert(id);
        $.ajax({
            url: '<?php echo base_url(); ?>admin/patient/editIpdCharges',
            type: "POST",
            data: {
                id: id
            },
            ...
            success: function(data) {
                ...
                var dt = new Date(data.date).toString(date_format);


                $("#echarge_date").val(dt);
                $("#uid").val(id);
                $("#echarge_type").val(data.charge_type);
                // $("#echarge_category").val(data.charge_category);
                // $("#ecode").val(data.code);
                $("#estandard_charge").val(data.standard_charge);
                $("#echarge_id").val(data.charge_id);
                $("#eschedule_charge").val(data.org_charge);
                $("#eapply_charge").val(data.apply_charge);

                // Set up the onchange event for echarge_type
                document.getElementById('echarge_type').onchange = function() {
                    var selectedValue = this.value;
                    // Pass the selected value and the original charge category to the getcharge_category function
                    getcharge_category(selectedValue, data.charge_category);
                };

                // Set up the onchange event for charge_category
                document.getElementById('echarge_category').onchange = function() {
                    var selectedValue = this.value;
                    // Pass the selected value and the original charge category to the getcharge_category function
                    getchargecode(selectedValue, data.cid);
                };

                // Manually trigger the onchange event after setting the value
                $("#echarge_type").change();

                // Manually trigger the onchange event after setting the value
                $("#echarge_category").change();

                // Display the modal
                holdModal('myEditChargesModal');
    ...
    $(document).ready(function(e) {
        $("#update_charges").on('submit', (function(e) {
            e.preventDefault();
            $("#update_chargesbtn").button('loading');
            $.ajax({
                url: '<?php echo base_url(); ?>admin/charges/update_ipdcharges',
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
                ...
                success: function(data) {
                    ...
                    $("#update_chargesbtn").button('reset');
                },
                error: function() {}
            });
        }));
    ...
    function editIpdPayment(id) {

        // alert(id);
        $.ajax({
            url: '<?php echo base_url(); ?>admin/patient/editipdPayment',
            type: "POST",
            data: {
                id: id
            },
            ...
            success: function(data) {
                var date_format = '<?php echo $result = strtr($this->customlib->getSchoolDateFormat(), ['d' => 'dd', 'm' => 'MM', 'Y' => 'yyyy',]) ?>';
                var dt = new Date(data.date).toString(date_format);
                var chequedt = new Date(data.cheque_date).toString(date_format);

                var total = $("#charge_total").val();
                $("#etotal").val(total);
                $("#edate").val(dt);
                $("#eamount").val(data.paid_amount);
                $("#epayment_mode").val(data.payment_mode);
                $("#enote").val(data.note);
                $("#epid").val(data.id);
                $("#echeque_no").val(data.cheque_no);
                $("#last_paid").val(data.paid_amount);

                if (data.cheque_date == "0000-00-00") {
                    $("#echeque_date").val("");
                } else {
                    $("#echeque_date").val(chequedt);
                }

                holdModal('myEditPaymentModal');
                showPaymentByMode(data.payment_mode);
    ...
    $(document).ready(function(e) {
        $("#update_payment").on('submit', (function(e) {
            e.preventDefault();
            $("#update_paymentbtn").button("loading");
            $.ajax({
                url: '<?php echo base_url(); ?>admin/payment/updateIpdpayment',
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
                ...
                success: function(data) {
                    ...
                    $("#update_paymentbtn").button("reset");
                },
                error: function() {}
            });
        }));
    ...
    function showPaymentByMode(data) {
        var modetyp = data;
        if (modetyp === "Cheque") {
            $(".showhid").show();
        } else {
...
<script>
    ...
    $('#myEditPaymentModal, #myNurseNoteEditModal').on('hidden.bs.modal', function() {
        window.location.reload();
    });

    // 01-10-2024
    $(document).ready(function(e) {
        $("#add_nursenote").on('submit', (function(e) {
            var patient_id = $("#patient_id").val();
            e.preventDefault();
            $("#add_nursenotebtn").button('loading');
            $.ajax({
                url: "<?php echo site_url("admin/patient/add_nurse_note") ?>",
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
    ...
    function delete_nursenote(id) {
        var patient_id = $("#patient_id").val();
        if (confirm('<?php echo $this->lang->line("delete_conform") ?>')) {
            $.ajax({
                url: '<?php echo base_url(); ?>admin/patient/delete_nursenote/' + id,
                success: function(res) {
                    $('#nursenote_list').html(res);
                    successMsg('<?php echo $this->lang->line('delete_message'); ?>');
                    window.location.reload(true);
                },
                error: function() {
    ...
    function editNursenote(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                // var date_format = '<?php echo $result = strtr($this->customlib->getSchoolDateFormat(), ['d' => 'dd', 'm' => 'MM', 'Y' => 'yyyy',]) ?>';
                // var dt = new Date(data.timeline_date).toString(date_format);
                $("#enurse_note_id").val(data.id);
                $("#epatientid").val(data.patient_id);
                $("#enote").val(data.note);
                $("#enurse_note_date").val(data.nurse_note_date);
                $("#ecomment").val(data.comment);
                $("#nurse").val(data.nurse);
                $(".select2").select2().select2('val', data.nurse);
                $('select[id="nurse"] option[value="' + data.nurse + '"]').attr("selected", "selected");

                holdModal('myNurseNoteEditModal');
            },
        });
    }
    ...
    $(document).ready(function(e) {
        $("#edit_nursenote").on('submit', (function(e) {
            ...
            $.ajax({
                url: "<?php echo site_url("admin/patient/edit_patient_nursenote") ?>",
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
    ...
    function addcommentNursenote(id) {
        $("#nurse_noteid").val(id);
    ...
    $(document).ready(function(e) {
        $("#comment_nursenote").on('submit', (function(e) {
            ...
            e.preventDefault();
            $.ajax({
                url: "<?php echo site_url("admin/patient/add_comment_nursenote") ?>",
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
    ...
    function delete_comment_nursenote(id) {
        if (confirm('<?php echo $this->lang->line("delete_conform") ?>')) {
            $.ajax({
                url: '<?php echo base_url(); ?>admin/patient/delete_comment_nursenote/' + id,
                success: function(res) {
                    $('#nursenote_list').html(res);
                    successMsg('<?php echo $this->lang->line('delete_message'); ?>');
                    window.location.reload(true);
