            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <?php }
                        if ($this->rbac->hasPrivilege('opd diagnosis', 'can_view')) { ?>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="pull-right">
                                                            ...
                                                            <a href="#" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('print'); ?>" onclick="printVisitBill('<?php echo $value["patient_id"]; ?>', '<?php echo $value["id"]; ?>')">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="organisation" style="width:100%" class="form-control" id="edit_organisation" onchange="get_Charge('')">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="amount" class="form-control" id="edit_amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                        ...
                        <form id="" class="pt5 pb5" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                            <div class="table-responsive">
                                <table class="table mb0 table-striped table-bordered examples tablelr0space noborder">
                                    ...
                                    <tr id="hide">
                                        <th width="15%"><?php echo $this->lang->line('cheque') . " " . $this->lang->line('no'); ?></th>
                                        <td width="35%"><span id='chk_no'></span></td>

                                        <th width="15%"><?php echo $this->lang->line('cheque') . " " . $this->lang->line('date'); ?></th>
                                        <td width="35%"><span id='chk_date' style="text-transform: capitalize;"></span></td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="amount" type="text" class="form-control" id="revisit_amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <!-- <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="payment_mode" class="form-control" onchange="showPaymentByMode(this.value)" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="report_date" class="form-control datee" id="report_date" />
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    function get_Charge(id) {
        var orgid = $("#edit_organisation").val();
        if (id == '') {
            id = $("#edit_consdoctor").val();
        }
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res) {
                    if (orgid) {
                        $('#edit_amount').val(res.org_charge);
