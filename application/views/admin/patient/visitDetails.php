                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <a onclick="editCharges('<?php echo $charges_value['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>
                                                            ...
                                                            <a
                                                                onclick="printCharges('<?php echo $charges_value['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('print'); ?>">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            ...
                                                            <?php } ?>
                                                            <a onclick="editPayment('<?php echo $payment['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>
                                                            ...
                                                            <a onclick="printPayment('<?php echo $payment['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('print'); ?>">
                                                                <i class="fa fa-print"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right ipdbilltable"><input type="text" id="other_charge" value="<?php
                                                                                                                                            ...
                                                                                                                                            ?>" name="other_charge" style="width: 30%; float: right" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right ipdbilltable">
                                                                <input type="text" id="discount_percent" name="discount_percent" style="width: 30%; float: right" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right ipdbilltable">
                                                                <input type="text" id="tax_percent" name="tax_percent" style="width: 30%; float: right" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right fontbold20">
                                                                ...
                                                                <span id="grass_amount_span" class="">0</span>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right fontbold20">
                                                                ...
                                                                <span id="net_amount_span" class="">0</span><input type="hidden" name="net_amount" value="<?php
                                                                                                                                                            ...
                                                                                                                                                            ?>" id="net_amount_payble" style="width: 30%; float: right" class="form-control">
                                                            </td>
                                                        </tr>
                                                    <?php } else { ?>
                                                        <tr>
...
<div class="modal fade" id="editModal" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document" style="width:1000px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input name="epulse" id="epulse" type="text" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-sm-3 ">
                                    <div class="form-group">
                                        <label for="pwd"><?php echo $this->lang->line('temperature'); ?></label>
                                        <input name="etemperature" id="etemperature" type="text" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="pwd"><?php echo $this->lang->line('respiration'); ?></label>
                                        <input name="erespiration" id="erespiration" type="text" class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="epmi" name="epmi"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select id="edit_paymentmode" name="payment_mode" class="form-control" onchange="showPaymentByMode(this.value)">
                                ...
                                <div class="showhid">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cheque_no" id="echeque_no" class="form-control">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cheque_date" id="echeque_date" class="form-control date">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 paddlr">
                        <form id="add_charges" accept-charset="utf-8" method="post" class="ptt10">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('applied') . " " . $this->lang->line('charge') . " (" . $currency_symbol . ")" ?></label><small class="req"> *</small><input type="text" name="apply_charge" id="apply_charge" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                        ...
                        <form id="update_charges" accept-charset="utf-8" method="post" class="ptt10">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('standard') . " " . $this->lang->line('charge') . " (" . $currency_symbol . ")" ?></label>
                                        <input type="text" readonly name="estandard_charge" id="eaddstandard_charge" class="form-control" value="<?php echo set_value('standard_charge'); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('applied') . " " . $this->lang->line('charge') . " (" . $currency_symbol . ")" ?></label><small class="req"> *</small><input type="text" name="eapply_charge" id="eapply_charge" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                    ...
                    <form id="" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                        <div class="table-responsive">
                            <table class="table mb0 table-striped table-bordered examples tablelr0space">
                                ...
                                <tr id="hide">
                                    <th width="25%"><?php echo  $this->lang->line('cheque') . " " . $this->lang->line('no'); ?></th>

                                    <td width="25%"><span id='cheque_no'></span></td>
                                    <th width="25%"><?php echo $this->lang->line('cheque') . " " . $this->lang->line('date'); ?></th>

                                    <td width="25%"><span id='cheque_date'></span></td>
                                </tr>
                                <tr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="payment_mode" id="revisit_payment" class="form-control" onchange="showPaymentByMode(this.value)">
                            ...
                            <div class="row">
                                ...
                                <div class="showhid">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('cheque') . " " . $this->lang->line('date'); ?></label><small class="req"> *</small>
                                            <input type="text" name="cheque_date" id="cheque_date" class="form-control datee">
                                            <span class="text-danger"><?php echo form_error('cheque_date'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="epatient_id" id="epayment_patient_id" class="form-control">
                                        <input type="hidden" name="eopd_id" id="epayment_opd_id" class="form-control">
                                ...
                                <div class="showhid">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('cheque') . " " . $this->lang->line('no'); ?></label><small class="req"> *</small>
                                            <input type="text" name="echeque_no" id="echequeNo" class="form-control">
                                            <span class="text-danger"><?php echo form_error('cheque_no'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('cheque') . " " . $this->lang->line('date'); ?></label><small class="req"> *</small>
                                            <input type="text" name="echeque_date" id="echequeDate" class="form-control datee">
                                            <span class="text-danger"><?php echo form_error('cheque_date'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
...
<script type="text/javascript">
    ...
    function getchargecode(charge_category, code) {
        var edit_code = code;
    ...
    function getRecord(id, opdid, visitid = '') {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var dt = new Date(data.cheque_date).toString(date_format);

                if (data.payment_mode == "Cheque") {
                    $("#cheque_no").html(data.cheque_no);
                    $("#cheque_date").html(dt);
                    $("#hide").show();
                } else {
                    $("#hide").hide();
    ...
    function view_prescription(id, opdid, visitid, prescription = 'yes') {
        ...
        if (prescription == 'yes') {
            ...
            $('#edit_deleteprescription').html("<?php if ($this->rbac->hasPrivilege('prescription', 'can_view')) { ?><a href='#'' onclick='printprescription(" + id + "," + opdid + ")'   data-original-title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a><?php } ?><?php if ($this->rbac->hasPrivilege('prescription', 'can_edit')) { ?><a href='#'' onclick='edit_prescription(" + id + "," + opdid + "," + visitid + ")' data-target='#edit_prescription' data-toggle='modal'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            if ($this->rbac->hasPrivilege('prescription', 'can_delete')) { ?><a onclick='delete_prescription(" + id + "," + opdid + ")'  href='#'  data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('delete'); ?>'><i class='fa fa-trash'></i></a><?php } ?>");
        }
...
<script type="text/javascript">
    ...
    function printCharges(id) {
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'admin/charges/getCharges/' + id,
            type: 'POST',
            data: {
                payslipid: id,
                print: 'yes'
    ...
    function printPayment(id) {
        ...
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'admin/payment/getPrintPayments/' + id,
            type: 'POST',
            data: {
                payslipid: id,
                print: 'yes'
    ...
    function getcharge_category(id, id2) {
        var edit_chrg_cat = id2;
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $("#echarge_category").select2("val", edit_chrg_cat);
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res) {
                    ...
                    $('#eaddstandard_charge').val(res.standard_charge);
...
var paid_amount = $("#paid_amountpa").val() || 0;
var total_amount = $("#total_amount").val() || 0;
  ...
  $("#discount").val(discount.toFixed(2));
    ...
    function editCharges(id) {
        // alert(id);
        $.ajax({
            url: '<?php echo base_url(); ?>admin/patient/editCharges',
            type: "POST",
            data: {
                id: id
            },
            ...
            success: function(data) {
                ...
                $("#ecode").val(data.code);
                $("#eaddstandard_charge").val(data.standard_charge);
                $("#echarge_id").val(data.charge_id);
                $("#eschedule_charge").val(data.schedule_charge);
    ...
    $(document).ready(function(e) {
        $("#update_charges").on('submit', (function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>admin/charges/update_opdcharges',
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
    ...
    function editPayment(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var dt = new Date(data.date).toString(date_format);
                // var chequedt = new Date(data.cheque_date).toString(date_format);
                // Handle cheque_date: if it's '0000-00-00', set it as empty
                // var chequedt = (data.cheque_date && data.cheque_date !== '0000-00-00') ? new Date(data.cheque_date).toString(date_format) : '';
                var chequedt = new Date(data.cheque_date).toString(date_format);

                $("#echequeNo").val(data.cheque_no);
                if (data.cheque_date == "0000-00-00") {
                    $("#echequeDate").val("");
                } else {
                    $("#echequeDate").val(chequedt);
                }
                ...
                var opd_id = '<?php echo $visit_id ?>';
                $("#etotal").val(total);
                $("#epayment_opd_id").val(opd_id);
                $("#epayment_patient_id").val(patient_id);
                ...
                handleModalClose('myEditPaymentModal');
    ...
    $(document).ready(function(e) {
        $("#update_payment").on('submit', (function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>admin/payment/updateOPDPayment',
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
...
<script>
    ...
    // $('#myEditPaymentModal').on('hidden.bs.modal', function() {
    ...
    function handleModalClose(modalId) {
        $('#' + modalId).on('hidden.bs.modal', function () {
            location.reload();  // Reload the page after the specific modal is closed
        });
    }
</script>