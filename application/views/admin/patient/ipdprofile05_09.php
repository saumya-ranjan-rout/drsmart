                            ...
                            <table class="table table-striped mb0 font13">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th class="bozerotop">Hospital Department</th>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover example">
                                        <thead>
                                            ...
                                            <?php if ($this->rbac->hasPrivilege('opd editdiagnosis', 'can_delete') || $this->rbac->hasPrivilege('ipd diagnosis', 'can_delete')) { ?>
                                                <th class="text-right"><?php echo $this->lang->line('action'); ?></th>
                                            <?php } ?>
                                        </thead>
                                        <tbody>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <a onclick="editIpdCharges('<?php echo $charge['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="Edit">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>
                                                            <?php if ($this->rbac->hasPrivilege('charges', 'can_delete')) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if ($this->rbac->hasPrivilege('payment', 'can_delete')) { ?>
                                                            <td class="text-right">
                                                                ...
                                                                <?php } ?>
                                                                <a onclick="editIpdPayment('<?php echo $payment['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="Edit">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <?php if ($this->rbac->hasPrivilege('payment', 'can_delete')) { ?>
                        ...
                        <form id="formrevisit" accept-charset="utf-8" enctype="multipart/form-data" method="post" class="">
                            <div class="row">
                                <table class="table mb0 table-striped table-bordered examples">
                                    ...
                                    <tr>
                                        <th width="15%"><?php echo "Pulse"; ?></th>
                                        <td width="35%"><span id='pulse'></span></td>
                                        <th width="15%"><?php echo "Temperature"; ?></th>
                                        <td width="35%"><span id="temperature"></span>
                                        </td>
                                    </tr>

                                    <tr>
                                        <th width="15%"><?php echo "Respiration"; ?></th>
                                        <td width="35%"><span id='respiration'></span></td>
                                        <th width="15%"><?php echo "Previous Medical Issue"; ?></th>
...
<div class="modal fade" id="myEditPaymentModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"><?php echo 'Edit Payment'; ?></h4>
            </div>
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <form id="update_payment" accept-charset="utf-8" method="post" class="ptt10">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('payment') . " " . $this->lang->line('mode'); ?></label>
                                        <select class="form-control" name="epayment_mode" id="epayment_mode">
                                            <?php foreach ($payment_mode as $key => $value) {
                                            ?>
                                                <option value="<?php echo $key ?>" <?php
                                                                                    if ($key == 'cash') {
...
<div class="modal fade" id="myEditChargesModal" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"><?php echo "Edit Charges"; ?></h4>
            </div>
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                    ...
                                    <div class="ptt10">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label><?php echo "Previous medical issue"; ?></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <select class="form-control" name='hospital_department' id='hospital_departments'>
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
    ...
    function getEditRecord(id, ipdid) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('select[id="hospital_departments"] option[value="' + data.hospital_department + '"]').attr("selected", "selected");
    ...
    function getcharge_category(id, selectid) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $('#echarge_category').html("<option value=''>Select</option>");
    ...
    function getchargecode(charge_category, ecode) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $('#ecode').html("<option value=''>Select</option>");
