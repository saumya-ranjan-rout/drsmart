                            ...
                            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('discharge') . " " . $this->lang->line('status'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        foreach ($resultlist as $student) {
                                            ...
                                            if ($student["discharge_status"] == "approved") {
                                                $label = "class='label label-success'";
                                            } else if ($student["discharge_status"] == "under_review") {
                                        ...
                                        ?>
                                            <tr class="<?php echo $class; ?>">
                                                ...
                                                <td><small <?php echo $label ?>><?php echo $this->lang->line($student['discharge_status']); ?></small>
                                                    <?php
                                                    if ($logged_in_User_Role->id == 7 || $logged_in_User_Role->id == 1 || $logged_in_User_Role->id == 3) {
                                                        if ($student['discharge_status'] == 'under_review') {
                                                            if ($this->rbac->hasPrivilege('ipd_patient', 'can_view')) {
                                                    ?>
                                                                <a href="<?php echo base_url(); ?>admin/patient/status/<?php echo $student['ipdid']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('are_you_sure_you_want_to_discharge_this_patient'); ?>')" data-original-title="<?php echo $this->lang->line('approve') . " " . $this->lang->line('discharge'); ?>">
                                                        ...
                                                        if ($student['discharge_status'] == 'approved') {
                                                            if ($this->rbac->hasPrivilege('ipd_patient', 'can_view')) {
                                                        ?>
                                                                <a href="<?php echo base_url() ?>admin/patient/revertStatus/<?php echo $student['ipdid']; ?>" class="btn btn-default btn-xs" onclick="return confirm('<?php echo $this->lang->line('are_you_sure_you_want_to_revert_this_discharge_status') ?>')" data-toggle="tooltip" title="<?php echo $this->lang->line('revert') ?>">
    ...
    <li>
        ...
        <span id="alt_no"></span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="pwd"><?php echo $this->lang->line('previous_medical_issue'); ?></label>
                                            <textarea name="pmi" rows="3" class="form-control"><?php echo set_value('note'); ?></textarea>
                                        </div>
                                    </div>
                                </div><!--./row-->
                            </div><!--./col-md-8-->
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input id="admission_date" name="appointment_date" placeholder="" type="text" class="form-control datetimer" />
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div> <select id="hospital_department" name="hospital_department" placeholder="" type="text" class="form-control">
                                                    <option value="select"><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach ($department as $key => $value) {
                                                    ?>
                                                        <option value="<?php echo $value["id"] ?>" <?php echo set_select('hospital_department', $value['id'], set_value('hospital_department')); ?>><?php echo $value["department_name"] ?></option>
                                                    <?php }
                                                    ?>
                                                </select>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div><input class="form-control" type='text' name='credit_limit' value="<?php echo $setting[0]['credit_limit']; ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" readonly />
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div><select class="form-control select2" style="width: 100%" name='bed_no' id='bed_no'>
                                                    ...
                                                    <!--option value="<?php //echo $bed["id"]    
                                                                        ?>"><?php //echo $bed["name"]." + ".$bed["bed_type"]     
                                                                            ?></option-->
                                                    <?php //}    
                                                    ?>
                                                </select>
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped table-bordered table-hover" id="tableID">
                                    ...
                                    <tr id="row0">
                                        ...
                                        <td><input type="text" id="insdate0"name="insdate[]" value="" class="form-control"></td>
    ...
    function getBed(bed_group, bed = '') {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $("#bed_no").html("<option value=''><?php echo $this->lang->line('select') ?></option>");
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var currentDateTime = moment().format(datetime_format);

        $('.datetimer').datetimepicker({
            format: datetime_format,
            maxDate: moment().endOf('day'), // Restricts future dates
            defaultDate: moment(), // Sets the default to the current date and time
            useCurrent: true // Automatically uses the current date and time as the default
        });

        // If you want to set the value of the input to the current date and time when the page loads
        $('.datetimer').val(currentDateTime);
    });
</script>
