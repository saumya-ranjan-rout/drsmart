                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="guardian_name" id="guardian_name" placeholder="" value="" class="form-control">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="dob" id="birth_date" placeholder="" class="form-control datet" /><?php echo set_value('dob'); ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-5" id="calculate">
                                                <div class="form-group">
                                                    ...
                                                    <div style="clear: both;overflow: hidden;">
                                                        <input type="text" placeholder="<?php echo $this->lang->line('year') ?>" name="age" id="age_year" value="" class="form-control" style="width: 43%; float: left;" readonly>
                                                        <input type="text" id="age_month" placeholder="<?php echo $this->lang->line('month') ?>" name="month" value="" class="form-control" style="width: 53%;float: left; margin-left: 4px;" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!--<div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input id="number" autocomplete="off" name="mobileno"  type="text" placeholder="" class="form-control"  value="<?php echo set_value('mobileno'); ?>" required/>
                                        </div>
                                    </div> -->
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" style="display:flex;">
                                                ...
                                                <input id="number" autocomplete="off" name="number" type="text" placeholder="" class="form-control" value="<?php echo set_value('mobileno'); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" placeholder="" id="addformemail" value="<?php echo set_value('email'); ?>" name="email" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('national_identification_number'); ?></label>
                                            <input name="identification_number" placeholder="" class="form-control" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" onchange="get_Charges('')"  name='tpa'>
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input name="tpa_id" placeholder="" class="form-control" /><?php echo set_value('address'); ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="address"><?php echo 'TPA'." ".'Validity'; ?></label>
                                            <input type="text" name="tpa_validity" placeholder="" class="form-control date" /><?php echo set_value('tpa_validity'); ?>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="input-group" style="display:flex;">
                                                <div class="input-group-prepend">
                                                    <select id="countryCode" name="countryCode_altno" class="form-control" style="padding: 0px;width: 58px;">
                                                        <option value="+965">+965</option>
                                                        <option value="+962">+962</option>
                                                    </select>
                                                </div>
                                                <input id="number" autocomplete="off" name="alternative_no" type="text" placeholder="" class="form-control" value="<?php echo set_value('alternative_no'); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
