                                ...
                                <div class="col-md-3">
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="publish_date" name="publish_date"  placeholder="" type="text" class="form-control"  value="<?php echo set_value('publish_date'); ?>" />
 ...
 $(document).ready(function () {
        ...
        $('#date').datepicker({
         ...
         //   $('#follow_up_date').datepicker('setStartDate', selectedDate); // Set follow-up date start after selected date
            $('#publish_date').datepicker('setStartDate', selectedDate).prop('disabled', false); // Enable and set follow-up date start after selected date
...
$('#publish_date').val(''); 
        ...
        $('#publish_date').datepicker().on('changeDate', function (e) {
            var dateVal = $('#date').datepicker('getDate');
            var followUpDateVal = $('#publish_date').datepicker('getDate');

            if (followUpDateVal < dateVal) {
                alert("The follow-up date must be greater than the selected date.");
                $('#publish_date').val(''); // Clear invalid follow-up date
            }
        });
    });
