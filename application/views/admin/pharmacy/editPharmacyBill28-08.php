...
<?php } ?>
    ...
    <?php } ?>
                                    ...
                                    <td class="text-right">
                                        <input type="text" name="sale_price[]" onchange="multiply(<?php echo $i ?>)" id="sale_price_edit<?php echo $i ?>" value="<?php echo $value['sale_price']; ?>" placeholder="Sale Price" class="form-control text-right numberInput"  />
                    ...
                    <div class="col-sm-6">
                        ...
                        <table class="printablea4">
                            ...
                            <tr>
                                ...
                                <td class="text-right ipdbilltable"><h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4><input type="text" placeholder="Discount"  name="discount_percent" id="editdiscount_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control numberInput" value="<?php echo $result["discount_percent"] ?>" /></td>
                            ...
                            <tr>
                                ...
                                <td class="text-right ipdbilltable">
                                    <h4 style="float: right;font-size: 12px;padding-left: 5px;"> %</h4><input type="text" placeholder="Tax" name="tax_percent"  id="edittax_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control numberInput" value="<?php echo $result["tax_percent"] ?>" />
                                </td>
