                ...
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            ...
                            <td align="right"><h5><?php echo $this->lang->line('purchase') . " " .$this->lang->line('date') . " : "; ?><?php echo date($this->customlib->getSchoolDateFormat(true, true), strtotime($result['date'])) ?></h5>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="printablea4" width="100%" style="width:30%;float:left;">
                        <tr>
                            <td>
                                ...
                                <p id="doc"><?php echo $this->lang->line('document') . " : "; ?><span>
                                ...
                                <?php } ?>
                                <p><?php echo $this->lang->line('payment') . " " . $this->lang->line('note') . " : "; ?><?php echo $result["payment_note"]; ?></p>
...
<script type="text/javascript">
    ...
    frameDoc.document.write('@media print { #doc { display: none; } }');
