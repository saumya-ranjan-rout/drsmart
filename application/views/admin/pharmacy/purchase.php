                                        ...
                                        <td>
                                            <?php if ($this->rbac->hasPrivilege('medicine_purchase', 'can_view')) { ?>
                                                <a href="#" onclick="viewDetail('<?php echo $pharmacy['id'] ?>')"
                                                    data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>"><?php echo $pharmacy['ref_no']; ?></a>
                                            <?php } ?>
                                        </td>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="row">
                            <div class="col-lg-3 col-sm-4 col-xs-5">
                                <label><?php echo $this->lang->line('purchase') . " " . $this->lang->line('date'); ?><small class="req" style="color:red;"> *</small></label>
                            </div><!--./col-sm-6-->
                            <div class="col-lg-5 col-sm-4 col-xs-7">
                                <input name="date" id="date_supplier" type="text" value="<?php echo date($this->customlib->getSchoolDateFormat(true, true)) ?>" class="form-control datetimer" />
                                    ...
                                    <div class="">
                                        <table class="table table-striped table-bordered table-hover" id="tableID">
                                            ...
                                            <tr id="row0">
                                                ...
                                                <td>
                                                    <input type="text" name="batch_no[]" id="batchno0" class="form-control" onchange="checkbatch(0)">
                                                ...
                                                <td>
                                                    <input type="text" name="mrp[]" id="mrp" class="form-control numberInput">
                                                    <span class="text-danger"><?php echo form_error('mrp[]'); ?>
                                                    </span>
                                                </td>

                                                <td>
                                                    <input type="text" name="batch_amount[]" id="batch_amount" class="form-control numberInput">
                                                    <span class="text-danger"></span>
                                                </td>
                                                <td>
                                                    <input type="text" name="sale_rate[]" id="sale_price" class="form-control numberInput">
                                                    <span class="text-danger"><?php echo form_error('sale_rate[]'); ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    <input type="text" name="packing_qty[]" id="packing_qty" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                                    <span class="text-danger"><?php echo form_error('packing_qty[]'); ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    <div class="input-group">
                                                        <input type="text" name="quantity[]" onkeyup="multiply(0)" id="quantity0" class="form-control text-right" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                                    </div>
                                                </td>

                                                <td class="text-right">

                                                    <input type="text" name="purchase_price[]" onkeyup="multiply(0)" id="purchase_price0" placeholder="" class="form-control text-right numberInput">
                                                    <span class="text-danger"><?php echo form_error('purchase_price[]'); ?></span>
                                                </td>

                                                <td class="text-right">
                                                    <input type="text" name="amount[]" id="amount0" placeholder="" class="form-control text-right numberInput" readonly>
                                        ...
                                        <div class="col-sm-6">
                                            <table class="printablea4">
                                                <tr>
                                                    ...
                                                    <td width="40%" colspan="2" class="text-right ipdbilltable"><input type="text" placeholder="Total" value="0" name="total" id="total" style="width: 30%; float: right" class="form-control" readonly /></td>
                                                </tr>

                                                <tr>
                                                    <th><?php echo $this->lang->line('discount') . " (" . $currency_symbol . ")"; ?></th>
                                                    <td class="text-right ipdbilltable">
                                                        <h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4><input type="text" placeholder="<?php echo $this->lang->line('discount'); ?>" value="" name="discount_percent" id="discount_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control numberInput" onkeyup="addTotal()" />
                                                    </td>

                                                    <td class="text-right ipdbilltable"><input type="text" placeholder="Discount" value="0" name="discount" id="discount" style="width: 50%; float: right" class="form-control" readonly /></td>
                                                </tr>

                                                <tr>
                                                    <th><?php echo $this->lang->line('tax') . " (" . $currency_symbol . ")"; ?></th>
                                                    <td class="text-right ipdbilltable">
                                                        <h4 style="float: right;font-size: 12px;     padding-left: 5px;"> %</h4><input type="text" placeholder="<?php echo $this->lang->line('tax'); ?>" name="tax_percent" value="" id="tax_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control numberInput" onkeyup="addTotal()" />
                                                    </td>

                                                    <td class="text-right ipdbilltable">
                                                        <input type="text" placeholder="Tax" name="tax" value="0" id="tax" style="width: 50%; float: right" class="form-control" readonly />
                                                    </td>
                                                </tr>
                                                <tr>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label><?php echo $this->lang->line('payment') . " " . $this->lang->line('note'); ?></label>
                                                        <textarea type="text" name="payment_note" id="payment_note" class="form-control" rows="2"></textarea>
                                                    </div>
                                                </div>
                                                <div class="showhid">
                                                    <div class="col-md-4">
                    ...
                    <div class="col-sm-4">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-sm-6 col-xs-7">
                                <input name="date" id="dateedit_supplier" type="text" value="" class="form-control datetimer" />
                                <span class="text-danger"><?php echo form_error('date'); ?></span>
                            </div><!--./col-sm-6-->
                        </div><!--./row-->
                    </div><!--./col-sm-6-->
...
<script>
    function getmedicine_name(id, rowid) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $("#medicine_name" + rowid).html("<option value=''><?php echo $this->lang->line('select') ?></option>");
    ...
    function edit_bill(id, purchase_no, supplier_id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                var date_format = '<?php echo $result = strtr($this->customlib->getSchoolDateFormat(true, false), ['d' => 'dd', 'm' => 'MM', 'Y' => 'yyyy',]) ?>';
                var indate = new Date(data.date);

                // Format date using the custom format and replace / with -
                var formattedDate = indate.toLocaleDateString('en-GB', {
                    day: '2-digit',
                    month: '2-digit',
                    year: 'numeric'
                }).replace(/\//g, '-');

                // Get the time in the desired format (HH:MM)
                var formattedTime = indate.toLocaleTimeString('en-US', {
                    hour: '2-digit',
                    minute: '2-digit'
                });
                ...
                $('#dateedit_supplier').val(formattedDateTime);
    ...
    <td><input type='text' name='batch_amount[]' id='batch_amount${id}' class='form-control mrp'></td>
    <td><input type='text' name='sale_rate[]' id='salerate${id}' class='form-control sale_rate'></td>
    <td><input type='text' name='packing_qty[]' id='packingqty${id}' class='form-control packing_qty' 
               oninput='this.value = this.value.replace(/[^0-9]/g, "");'></td>
    <td><input type='text' name='quantity[]' onkeyup='multiply(${id})' 
               oninput='this.value = this.value.replace(/[^0-9]/g, "");' 
               id='quantity${id}' class='form-control text-right'></td>
    <td><input type='text' onkeyup='multiply(${id})' name='purchase_price[]' id='purchase_price${id}' class='form-control text-right'></td>
    <td><input type='text' name='amount[]' id='amount${id}' class='form-control text-right'></td>
`;
  ...
  var editdate = $("#date_supplier").val();
    ...
    function multiply(id) {
        ...
        if (quantity > 0) {
            ...
            errorMsg('<?php echo $this->lang->line("order_quantity_greater_than_zero"); ?>');
            $('#quantity' + id).val('');
        }
    }
...
<script>
    function checkbatch(rowid) {
        // alert(rowid);
        var batchno = $('#batchno' + rowid).val();
        // alert(batchno);
        $.ajax({
            type: "POST",
            url: base_url + "admin/pharmacy/checkbatch/" + batchno,
            dataType: 'json',
            success: function(res) {
                // alert(res);
                if (res > 0) {
                    errorMsg('Batch No. Already Exists');
                    $('#batchno' + rowid).val('');
                } else {
                    $('#batchno' + rowid).val(batchno);
                }
            },
            error: function(xhr, status, error) {
                console.error("AJAX error:", status, error);
                errorMsg('An error occurred while checking the batch number.');
            }
        });
    }
</script>
