                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <?php if ($this->rbac->hasPrivilege('medicine_dosage', 'can_edit') || $this->rbac->hasPrivilege('medicine_dosage', 'can_delete')) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('medicine_dosage', 'can_edit') || $this->rbac->hasPrivilege('medicine_dosage', 'can_delete')) { ?>
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        ?>
                                                            <a class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordById('<?php echo base_url(); ?>admin/medicinedosage/delete/<?php echo $dosage['id'] ?>', '<?php echo $this->lang->line('delete_message'); ?>')" ;>
