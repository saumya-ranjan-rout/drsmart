                                        ...
                                        <div class="col-sm-6">
                                            <table class="printablea4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right ipdbilltable"><h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4><input type="number" placeholder="Discount"  name="discount_percent" id="discount_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control numberInput"/></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right ipdbilltable">
                                                        <h4 style="float: right;font-size: 12px;     padding-left: 5px;"> %</h4><input type="number" placeholder="Tax" name="tax_percent" id="tax_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control numberInput"/>
            ...
            success: function (data) {
                ...
                for (var k = 0; k < rowCount; k++) {
                    ...
                    if (madicinecategoryk == madicinecategory && medicinek == medicine && batch_nok == batch_no) {
                        whole_qty += parseInt(quantityk) || 0; // Ensure quantityk is an integer
                    }
                }

                var availquantity = quantity - whole_qty;
                $('#id' + id).val(data.id);
          ...
          //  alert(JSON.stringify(res));
            ...
            if (res != null) {
                ...
                if (expiry_date < current_month_year) {
                    ...
                    $("#medicine_name" + id).html("<option value=''>Select</option>");
                    $('#medicine_name' + id).select2("val", '');
                    $("#batch_no" + id).html("<option value=''>Select</option>");
                    $('#expire_date' + id).val('');
                } else {
