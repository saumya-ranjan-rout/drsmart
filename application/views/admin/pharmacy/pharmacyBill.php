                                    ...
                                    ?>
                                        <tr class="">
                                            ...
                                            <td class="pull-right">
                                                ...
                                                <a href="#"
                                                    onclick="directPrintBill(<?php echo $bill['id'] ?>)"
                                                    class="btn btn-default btn-xs" data-toggle="tooltip"
                                                    title="<?php echo $this->lang->line('print'); ?>">
                                                    <i class="fa fa-print"></i>
                                                </a>
                ...
                <div class="row modalbillform">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-sm-3 col-xs-3">
                                <label><?php echo $this->lang->line('bill') . " " . $this->lang->line('date'); ?><small class="req" style="color:red;"> *</small></label>
                            </div>
                            <div class="col-lg-5 col-sm-3 col-xs-9">
                                <input name="date" id="date_pharmacy" type="text" value="<?php echo date($this->customlib->getSchoolDateFormat(true, true)) ?>" class="form-control datetimer" />
                                ...
                                <div class="col-md-12" style="clear:both;">
                                    <div class="">
                                        <table class="table table-striped table-bordered table-hover" id="tableID">
                                            ...
                                            <tr id="row0">
                                                <td width="16%">
                                                    <select class="form-control" name='medicine_category_id[]' id='medicine_category_id0' onchange="getmedicine_name(this.value, '0')">
                                                ...
                                                <td>
                                                  ...
                                                  <span id="totalqty0" class="text-danger"><?php echo form_error('quantity[]'); ?></span> -->
                                                    <div class="input-group">
                                                        <input type="number" name="quantity[]" onkeyup="multiply(0)" onfocus="getQuantity(0)" id="quantity0" class="form-control text-right">
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <input type="text" name="sale_price[]" onchange="multiply(0)" id="sale_price0" placeholder="" class="form-control text-right numberInput">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div><select name='consultant_doctor' style="width:100%;" id="consultant_doctor" onchange="get_Docname(this.value)" class="form-control select2"
                                                                        <?php
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="doctor_name" id="doctname" type="text" class="form-control" readonly/>
                                            ...
                                            <table class="printablea4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right ipdbilltable">
                                                        <h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4><input type="number" placeholder="<?php echo $this->lang->line('discount'); ?>" name="discount_percent" id="discount_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control numberInput" />
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right ipdbilltable">
                                                        <h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4><input type="number" placeholder="<?php echo $this->lang->line('tax'); ?>" name="tax_percent" id="tax_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control numberInput" />
                                                    </td>
...
<?php } ?> 
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-sm-3 col-xs-9">
                                <input name="edit_date" id="editdate" type="text" value="" class="form-control datetimer"/>
                            </div>
                        </div><!--./row-->
                    </div><!--./col-sm-6-->
...
<script type="text/javascript">
    ...
    function formatDate(date, format) {
        ...
        return format.replace(/dd|MM|yyyy|hh|mm|ss|A/gi, matched => map[matched]);
    }
            ...
            success: function(data) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        holdModal('edit_bill');
                        get_PatienteditDetails(patient_id);
                    },
                    error: function() {
                        alert("Fail")
                    }
 ...
 var editdate = $("#date_pharmacy").val();
    ...
    function addTotal() {
        ...
        for (var i = 0; i < sale_price.length; i++) {
            ...
            var inpvalue = inp.value == '' ? 0 : inp.value;
        ...
        // Set default values for discount and tax if they are blank
  ...
  var editdate = $("#date_pharmacy").val();
    ...
    function directPrintBill(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                printWindow.document.write('<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>path_to_your_styles.css">'); // Include your CSS file
                printWindow.document.write('</head><body >');
                printWindow.document.write(data); // Add the content to print
    ...
    function getQuantity(id) {
        ...
        var madicinecategory = $("#medicine_category_id" + id).val();

        if (batch_no != "") {
            $('#quantity').html(""); // This might be unnecessary since you update individual quantity fields below
            $.ajax({
                type: "GET",
                ...
                dataType: 'json',
                success: function(data) {
                    var quantity = data.available_quantity;
                    var table = document.getElementById("tableID");
                    var rowCount = table.rows.length;

                    var count = 0;
                    for (var k = 0; k < rowCount; k++) {
                        var madicinecategoryk = $("#medicine_category_id" + k).val();
                        var medicinek = $("#medicine_name" + k).val();
                        var batch_nok = $("#batch_no" + k).val();
                    ...
                    if (count > 1) {
                        ...
                        $("#batch_no" + id).val("");
                        $('#totalqty' + id).html('');
                        $('#available_quantity' + id).val('');
                        $('#sale_price' + id).val('');
                    } else {

                        var availquantity = quantity;
                        $('#id' + id).val(data.id);
                        $('#totalqty' + id).html(availquantity);
                        $('#available_quantity' + id).val(availquantity);
    ...
    function getExpire(id) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res != null) {
                    var current_month_year = new Date(); // current date

                    //alert(res.expiry_date); // e.g., "Feb/2024"

                    // Parse the expiry date received from the server (assuming format is MMM/YYYY)
                    var expiry_parts = res.expiry_date.split('/');
                    var expiry_date = new Date(expiry_parts[1], getMonthFromString(expiry_parts[0]), 1);

                    // alert(expiry_date);  // e.g., "Sun Feb 01 2026 00:00:00 GMT+0530 (India Standard Time)"
                    // alert(current_month_year);  // e.g., "Fri May 31 2024 12:46:01 GMT+0530 (India Standard Time)"

                    // Set the time part to midnight for accurate comparison
                    expiry_date.setHours(0, 0, 0, 0);
                    current_month_year.setHours(0, 0, 0, 0);

                    if (expiry_date < current_month_year) {
                        alert("Medicine Expired");
                        $("#medicine_category_id" + id).val('');
                        $("#medicine_name" + id).html("<option value=''><?php echo $this->lang->line('select') ?></option>");
                        $('#medicine_name' + id).select2("val", '');
                        $("#batch_no" + id).html("<option value=''><?php echo $this->lang->line('select') ?></option>");
                        $('#expire_date' + id).val('');
                    } else {
