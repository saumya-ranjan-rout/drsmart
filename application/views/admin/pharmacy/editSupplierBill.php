                        ...
                        <table class="table table-striped table-bordered table-hover" id="edittableID">
                            ...
                            ?>
                                ...
                                <tr id="row<?php echo $i ?>">
                                    ...
                                    <td>
                                        <input type="text" name="batch_no[]" id="batch_edit_no<?php echo $i ?>" onchange="checkbatch(<?php echo $i ?>,<?php echo $value['id']; ?>)" class="form-control" value="<?php echo $value['batch_no']; ?>">
                                        <span class="text-danger"><?php echo form_error('batch_no[]'); ?>
                                        </span>
                                    </td>
                                    <td>
                                        <input type="text" name="expiry_date[]" id="edit_expiry_date<?php echo $i ?>" class="form-control expires_date" value="" readonly>
                                        <span class="text-danger"><?php echo form_error('expiry_date[]'); ?>
                                        </span>
                                    </td>

                                    <td>
                                        <input type="text" name="mrp[]" id="mrp_edit<?php echo $i ?>" class="form-control numberInput" value="<?php echo $value['mrp']; ?>">
                                        <span class="text-danger"><?php echo form_error('mrp[]'); ?>
                                        </span>
                                    </td>
                                    <td>
                                        <input type="text" name="batch_amount[]" id="batchamount_edit<?php echo $i ?>" class="form-control numberInput" value="<?php echo $value['batch_amount']; ?>">
                                        <span class="text-danger"><?php echo form_error('mrp[]'); ?>
                                        </span>
                                    </td>
                                    <td>
                                        <input type="text" name="sale_rate[]" id="sale_rate_edit<?php echo $i ?>" class="form-control numberInput" value="<?php echo $value['sale_rate']; ?>">
                                        <span class="text-danger"><?php echo form_error('sale_rate[]'); ?>
                                        </span>
                                    </td>
                                    <td>
                                        <input type="text" name="packing_qty[]" id="packing_qty_edit<?php echo $i ?>" class="form-control" value="<?php echo $value['packing_qty']; ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                    ...
                                    <td class="text-right">
                                      ...
                                      <span id="totaleditqty<?php echo $i ?>" class="text-danger"><?php echo form_error('quantity[]'); ?></span-->
                                        <div class="input-group">
                                            <input type="text" name="quantity[]" onkeyup="multiply(<?php echo $i ?>)" onfocus="geteditQuantity(<?php echo $i ?>)" value="<?php echo $value['quantity']; ?>" id="quantity_edit<?php echo $i ?>" class="form-control text-right" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                    ...
                                    <td class="text-right">
                                        <input type="text" name="purchase_price[]" onkeyup="multiply(<?php echo $i ?>)" id="purchase_price_edit<?php echo $i ?>" placeholder="purchase Price" class="form-control text-right numberInput" value="" />
                            ...
                            <table class="printablea4">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right ipdbilltable">
                                        <h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4><input type="text" placeholder="<?php echo $this->lang->line('discount'); ?>" value="<?php echo $result["discount_percent"] ?>" name="discount_percent" id="editdiscount_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control numberInput" onkeyup="addEditTotal()" />
                                    </td>
                                    <td class="text-right ipdbilltable"><input type="text" placeholder="Discount" value="<?php echo $result["discount"] ?>" name="discount" id="editdiscount" style="width: 50%; float: right" class="form-control" readonly /></td>
                                </tr>
                                <tr>
                                    <th><?php echo $this->lang->line('tax') . " (" . $currency_symbol . ")"; ?></th>

                                    <td class="text-right ipdbilltable">
                                        <h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4><input type="text" placeholder="<?php echo $this->lang->line('tax'); ?>" name="tax_percent" value="<?php echo $result["tax_percent"] ?>" id="edittax_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control numberInput" onkeyup="addEditTotal()" />
                                    </td>
                                    <td class="text-right ipdbilltable"><input type="text" placeholder="Tax" name="tax" value="<?php echo $result["tax"] ?>" id="edittax" style="width: 50%; float: right" class="form-control" readonly /></td>
                                </tr>
                                <tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="payment_note" id="payment_note" class="form-control" rows="2"><?php echo $result["payment_note"] ?></textarea>
                                    </div>
                                </div>
...
<script>
    function checkbatch(rowid, id = null) {
        var batchno = $('#batch_edit_no' + rowid).val();
        var url;

        if (id !== null) {
            url = "admin/pharmacy/checkbatch/" + batchno + "/" + id;
        } else {
            url = "admin/pharmacy/checkbatch/" + batchno;
        }
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res > 0) {
                    ...
                    $('#batch_edit_no' + rowid).val('');
                } else {
                    $('#batch_edit_no' + rowid).val(batchno);
                }
            },
