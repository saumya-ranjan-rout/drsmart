                        ...
                        <table class="table table-striped table-bordered table-hover" id="edittableID">
                            ...
                            foreach ($detail as $key => $value) {
                                ...
                                <tr id="row<?php echo $i ?>">
                                    ...
                                    <td>
                                        <input type="number"  name="packing_qty[]" id="packing_qty_edit<?php echo $i ?>" class="form-control" value="<?php echo $value['packing_qty']; ?>" >
                                    ...
                                    <td class="text-right">
                                      ...
                                      <span id="totaleditqty<?php echo $i ?>" class="text-danger"><?php echo form_error('quantity[]'); ?></span-->
                                        <div class="input-group">
                                            <input type="number" name="quantity[]" onchange="multiply(<?php echo $i ?>)" onfocus="geteditQuantity(<?php echo $i ?>)" value="<?php echo $value['quantity']; ?>" id="quantity_edit<?php echo $i ?>" class="form-control text-right">
                                    ...
                                    <td class="text-right">
                                        <input type="text" name="purchase_price[]" onchange="multiply(<?php echo $i ?>)" id="purchase_price_edit<?php echo $i ?>" placeholder="purchase Price" class="form-control text-right numberInput" value=""/>
                                        <span class="text-danger"><?php echo form_error('purchase_price[]'); ?></span>
                                    </td>
                                    <td class="text-right">
                                        <input type="text" name="amount[]" id="amount_edit<?php echo $i ?>" placeholder="Amount" class="form-control text-right numberInput" value="<?php echo $value['amount']; ?>"/>
                        ...
                        <div class="col-sm-6">
                            ...
                            <table class="printablea4">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right ipdbilltable"><h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4><input type="text" placeholder="Discount" value="<?php echo $result["discount_percent"] ?>" name="discount_percent" id="editdiscount_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control numberInput"/></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right ipdbilltable">
                                        <h4 style="float: right;font-size: 12px;     padding-left: 5px;"> %</h4><input type="text" placeholder="Tax" name="tax_percent" value="<?php echo $result["tax_percent"] ?>" id="edittax_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control numberInput"/>
                                    </td>
