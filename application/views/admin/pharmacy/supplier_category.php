                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('medicine_supplier', 'can_delete')) {
                                                    ?>
                                                    <a  class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordById('<?php echo base_url(); ?>admin/medicinecategory/deletesupplier/<?php echo $supplier['id'] ?>', '<?php echo $this->lang->line('delete_message'); ?>')">
                ...
                <div class="modal-body pt0 pb0">    
                    <div class="ptt10">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('supplier') . " " . $this->lang->line('contact'); ?></label><small class="req"> *</small>
                                    <div class="input-group" style="display:flex;">
                                        <div class="input-group-prepend">
                                            <select id="countryCode3" name="countryCode3" class="form-control" style="padding: 0px;width: 58px;">
                                                <option value="+965">+965</option>
                                                <option value="+962">+962</option>
                                                <!-- Add other country codes here as needed -->
                                            </select>
                                        </div>
                                        <input id="number3" name="number3" autocomplete="off" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="" class="form-control" value="<?php
                                        if (isset($result)) {
                                            echo $result["contact"];
                                        }
                                        ?>" />
                                        <span class="text-danger"><?php echo form_error('number3'); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('contact_person_phone'); ?></label><small class="req"> *</small>
                                        <div class="input-group" style="display:flex;">
                                            <div class="input-group-prepend">
                                            ...
                                            <input id="number" autocomplete="off" name="number"  type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="" class="form-control"  value="<?php
                                            if (isset($result)) {
                                                echo $result["supplier_person_contact"];
                                            }
                                            ?>" />
                    ...
                    <div class="row ptt10">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group" style="display:flex;">
                                    <div class="input-group-prepend">
                                        <select id="countryCode4" name="countryCode4" class="form-control" style="padding: 0px;width: 58px;">
                                            <option value="+965">+965</option>
                                            <option value="+962">+962</option>
                                            <!-- Add other country codes here as needed -->
                                        </select>
                                    </div>
                                    <input id="number4" name="number4" autocomplete="off" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="" class="form-control" value="<?php
                                    if (isset($result)) {
                                        echo $result["contact"];
                                    }
                                    ?>" />
                                    <span class="text-danger"><?php echo form_error('number4'); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="display:flex;">
                                            <div class="input-group-prepend">
                                                <select id="countryCode2" name="countryCode2" class="form-control" style="padding: 0px;width: 58px;">
                                                    <option value="+965">+965</option>
                                                    <option value="+962">+962</option>
                                                </select>
                                            </div>
                                            <input id="number2" autocomplete="off" name="number2"  type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="" class="form-control"  value="<?php
                                            if (isset($result)) {
                                                echo $result["supplier_person_contact"];
                                            }
                                            ?>" />
    ...
    function get(id) {
        ...
        $.ajax({                                                                                                        
            ...
            success: function (result) {
                ...
                var mobileno = result.supplier_person_contact;
                var modifiedMobileno = mobileno.substring(4);
                var countryCode = mobileno.substring(0, 4);

                var mobileno1 = result.contact;
                var modifiedMobileno1 = mobileno1.substring(4);
                var countryCode1 = mobileno1.substring(0, 4);
                ...
                $('#number2').val(modifiedMobileno);
                $('#countryCode2').val(countryCode);
                //$('#contact').val(result.contact);
                $('#number4').val(modifiedMobileno1);
                $('#countryCode4').val(countryCode1);
