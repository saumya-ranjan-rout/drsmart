...
<?php } ?>
                                                ...
                                                <td>
                                                    <input type="number"  name="packing_qty[]"  id="packing_qty" class="form-control">
                                                    <span class="text-danger"><?php echo form_error('packing_qty[]'); ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    <div class="input-group">
                                                        <input type="number" name="quantity[]" onchange="multiply(0)"  id="quantity0" class="form-control text-right">
                                                    </div>
                                                </td>

                                                <td class="text-right">

                                                    <input type="text" name="purchase_price[]" onchange="multiply(0)" id="purchase_price0" placeholder="" class="form-control text-right numberInput">
