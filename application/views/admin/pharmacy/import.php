                        ...
                        <table class="table table-striped table-bordered table-hover" id="sampledata">
                            <thead>
                                <tr>
                                    ...
                                    foreach ($fields as $key => $value) {
                                        ...
                                        $add = "";
                                        if (($value == "medicine") || ($value == "company") || ($value == "composition") || ($value == "group") || ($value == "unit") || ($value == "packing")) {
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    foreach ($fields as $key => $value) {
                                        $int = '';
                                        if (($value == "min_level") || ($value == "reorder_level") || ($value == "vat")) {
                                            // $int = "<span>(Number Value)</span>";
                                            $int = "<span>(" . $this->lang->line('number_value') . ")</span>";
                                        }
                                    ?>
                                        <td><?php echo $this->lang->line('sample_data') . $int ?></td>
                                    <?php } ?>
                                </tr>
                            </tbody>
