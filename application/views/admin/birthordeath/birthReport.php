                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input id="birth_date" name="birth_date" placeholder="" type="text" class="form-control datetimer"   />
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="display:flex;">
                                            ...
                                            <input id="number" autocomplete="off" name="number"  type="text" placeholder="" class="form-control"  value="<?php echo set_value('phone'); ?>"  oninput="this.value = this.value.replace(/[^0-9]/g, '');"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
...
<?php echo $this->lang->line('child') . " " . $this->lang->line('photo'); ?>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('birth_date'); ?></label>
                                        <small class="req">*</small>
                                        <input value="<?php echo set_value('birth_date'); ?>" id="ebirth_date" name="birth_date" placeholder="" type="text" class="form-control datetimer"   />
                                        <span class="text-danger"><?php echo form_error('birth_date'); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="display:flex;">
                                            ...
                                            <input id="number2" autocomplete="off" name="number2"  type="text" placeholder="" class="form-control"  value="<?php echo set_value('phone'); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function get_PatientDetails(id) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/pharmacy/female_patientDetails',
            type: "POST",
            data: {id: id},
            dataType: 'json',
            success: function (res) {
                if(res.ipd_no==null){
                     $('#opd_ipd_no').val(res.opd_no);
                     $('#eopd_ipd_no').val(res.opd_no);
                    }else{
                     $('#opd_ipd_no').val(res.ipd_no);
                     $('#eopd_ipd_no').val(res.opd_no);
                    } 
