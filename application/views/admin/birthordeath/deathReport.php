                            ...
                            <tbody>
                                ...
                                if (empty($resultlist)) {
                                    ...
                                    foreach ($resultlist as $death) {
                                        ?>
                                        <tr class="">
                                             <td class=""><?php echo $death['ref_no']; ?></td>
                                            <td class=""><?php echo $death['opdipd_no']; ?></td>
                                            <td>
                                                <?php echo $death['patient_name']; ?>                                                  
                                            </td>
                                             <td class=""><?php echo $death['guardian_name']; ?></td>
                                            ...
                                            <td class="text-right">
                                                <a href="#" 
                                                    ...
                                                    <?php } if (!empty($death['image'])) { ?> 
    <a href="<?php echo base_url() . $death['image']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>" download>
...
?></label>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <small class="req">*</small>
                                        <input id="death_date" name="death_date" placeholder="" type="text" class="form-control datetimer"   />
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="guardian_name" id="guardian_name" class="form-control" readonly>    
...
?></label>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('death_date'); ?></label>
                                        <small class="req">*</small>
                                        <input id="edeath_date" value="<?php echo set_value('death_date'); ?>" name="death_date" placeholder="" type="text" class="form-control datetimer"   />
                                        <span class="text-danger"><?php echo form_error('death_date'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('guardian') . " " . $this->lang->line('name'); ?></label><small class="req"> *</small> 
                                        <input type="text" value="<?php echo set_value('guardian_name'); ?>" name="guardian_name" id="eguardian_name" class="form-control" readonly>    
                                        <span class="text-danger"><?php echo form_error('guardian_name'); ?></span>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function get_PatientDetails_old(id) {
        //$("#patient_name").html("patient_name");
        //$("#schedule_charge").html("schedule_charge");

        $.ajax({
            url: '<?php echo base_url(); ?>admin/pharmacy/death_patientDetails',
            type: "POST",
            data: {id: id},
            dataType: 'json',
            success: function (res) {
                if(res.ipd_no==null){
                     $('#opdipd_no').val(res.opd_no);
                     $('#eopdipd_no').val(res.opd_no);
                    }else{
                     $('#opdipd_no').val(res.ipd_no);
                     $('#eopdipd_no').val(res.opd_no);
                    }
        ...
        $.ajax({
            ...
            success: function (res) {
                if(res.guardian_name==null){
                     ...
                     $('#guardian_name').val(res.guardian_name);
                     $('#eguardian_name').val(res.guardian_name);
                    }
