            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            <!-- <td style="padding-top: 5px; font-size: 12px;">Reference No : <?php echo $result['ref_no']; ?></td>-->
                            <td align="text-left"><h5>Reference No : <?php echo $result['ref_no']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $this->lang->line('opd_ipd_no') . " #"; ?><?php echo $result["opdipd_no"] ?></h5>
                            </td>
