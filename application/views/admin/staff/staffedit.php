                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input autofocus="" id="employee_id" name="employee_id" placeholder="" value="<?php echo $staff["employee_id"] ?>" type="text" class="form-control" readonly />
                                        ...
                                        <div class="col-md-2" id="nurses_div" style="display: none;">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <input type="hidden" class="form-control" id="nurses" name="nurses" value="<?php echo $staff['nurses']; ?>" readonly>
                                                                                   ...
                                                                                   foreach ($nurses as $key => $nurse): ?>
                                                                                            <li>
                                                                                                <label for="ms-opt-<?php echo $key; ?>" style="padding-left: 23px;">
                                                                                                    <input type="checkbox" 
                                                                                                           value="<?php echo $nurse["id"]; ?>" 
                                                                                                           <?php if (in_array($nurse["id"], explode(',', $staff["nurses"]))) { echo "checked"; } ?> 
                                                                                                           title="<?php echo $nurse["name"]." ".$nurse["surname"]; ?>" 
                                                                                                           id="ms-opt-<?php echo $key; ?>">
                                                                                                    <?php echo $nurse["name"]." ".$nurse["surname"]; ?>
                                                                                                </label>
                                                                                            </li>
                                                                                        <?php endforeach; ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="email" placeholder="" type="email" class="form-control" value="<?php echo $staff["email"] ?>" />
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="username" name="username" placeholder="" type="text" class="form-control" value="<?php echo $staff["username"] ?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="dob" name="dob" placeholder="" type="text" class="form-control datee"
                                                    value="<?php
                                                            if (!empty($staff["dob"])) {
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input id="date_of_joining" name="date_of_joining" placeholder="" type="text" class="form-control date"
                                                    value="<?php
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group" style="display:flex;">
                                                    <?php $code = substr($staff["contact_no"], 0, 4);

                                                    ?>
                                                    <div class="input-group-prepend">
                                                        <select id="countryCode" name="countryCode" class="form-control" style="padding: 0px;width: 58px;">
                                                            <option value="+965" <?php echo ($code == '+965') ? 'selected' : ''; ?>>+965</option>
                                                            <option value="+962" <?php echo ($code == '+962') ? 'selected' : ''; ?>>+962</option>

                                                        </select>
                                                    </div>
                                                    <input id="contactno" autocomplete="off" name="contactno" type="text" placeholder="" class="form-control" value="<?php echo substr($staff["contact_no"], 4); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                                    <input id="editid" name="editid" placeholder="" type="hidden" class="form-control" value="<?php echo $staff["id"]; ?>" />
                                                </div>
                                                <span class="text-danger"><?php echo form_error('contactno'); ?></span>
                                            </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <?php $code1 = substr($staff["emergency_contact_no"], 0, 4);

                                                ?>
                                                <div class="input-group" style="display:flex;">
                                                    <div class="input-group-prepend">
                                                        <select id="countryCode1" name="countryCode1" class="form-control" style="padding: 0px;width: 58px;">
                                                            <option value="+965" <?php echo ($code1 == '+965') ? 'selected' : ''; ?>>+965</option>
                                                            <option value="+962" <?php echo ($code1 == '+962') ? 'selected' : ''; ?>>+962</option>
                                                        </select>
                                                    </div>
                                                    <input id="emg_contact" autocomplete="off" name="emg_contact" type="text" placeholder="" class="form-control" value="<?php echo substr($staff["emergency_contact_no"], 4); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="pan_number" name="pan_number" placeholder="" type="text" class="form-control" value="<?php echo $staff["pan_num"] ?>" />
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="nin" name="nin" placeholder="" type="text" class="form-control" value="<?php echo $staff["national_ide_no"] ?>" />
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="lin" name="lin" placeholder="" type="text" class="form-control" value="<?php echo $staff["local_ide_no"] ?>" />
                                            ...
                                            <div class="row around10">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="epf_no" name="epf_no" placeholder="" type="text" class="form-control" value="<?php echo $staff["epf_no"] ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<?php echo $staff["basic_salary"] ?>" class="form-control" name="basic_salary" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="row around10">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="bank_account_no" name="bank_account_no" placeholder="" type="text" class="form-control" value="<?php echo $staff["bank_account_no"] ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                                        <span class="text-danger"><?php echo form_error('bank_account_no'); ?></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
...
<script type="text/javascript">
    $(document).ready(function() {
        var someValue = <?php echo json_encode($staff["role_id"]); ?>; // Ensure proper JS format

        var selectedDesignation = <?php echo json_encode(!empty($staff['designation']) ? $staff['designation'] : set_value('designation')); ?>;
        getDesignation(someValue, selectedDesignation);
    });
</script>
...
<script type="text/javascript">
    ...
    $('#nurses').val(<?php echo json_encode($staff["nurses"]); ?>);
} else {
    $('#nurses_div').hide();
