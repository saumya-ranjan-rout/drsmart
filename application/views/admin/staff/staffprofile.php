                ...
                <div class="box box-primary" <?php
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('contract_type'); ?></b> <a class="pull-right text-aqua">
                                    <?php
                            ...
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('date_of_joining'); ?></b> <a class="pull-right text-aqua">
                                    <?php
                            ...
                            <?php if (($staff["is_active"] == 0)) { ?>
                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('date_of_leaving'); ?></b> <a class="pull-right text-aqua">
                                        <?php
                                ...
                                <div class="table-responsive around10 pt0">
                                    <table class="table table-hover table-striped tmb0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $this->lang->line('pan') . " " . $this->lang->line('number'); ?></td>
                                                <td><?php echo $staff['pan_num']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo $this->lang->line('national_identification_number'); ?></td>
                                                <td><?php echo $staff['national_ide_no']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo $this->lang->line('local_identification_number'); ?></td>
                                                <td><?php echo $staff['local_ide_no']; ?></td>
                                            </tr>
                                            <tr>
