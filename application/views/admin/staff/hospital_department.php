                ...
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <?php if ($this->rbac->hasPrivilege('designation', 'can_view')) { ?>
                         ...
                         <?php } if ($this->rbac->hasPrivilege('department', 'can_view')) { ?>
                            <li><a href="<?php echo base_url(); ?>admin/hospitaldepartment/" class="active"><?php echo $this->lang->line('hospital') ." ". $this->lang->line('department'); ?></a></li>
                        <?php } ?>   
                        <!-- <?php if ($this->rbac->hasPrivilege('department', 'can_view')) { ?>
            ...
            <div class="col-md-10">              
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('hospital') . " " . $this->lang->line('department'); ?> <?php echo $this->lang->line('list'); ?></h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            ...
                            <table class="table table-striped" id="dt_table">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('hospital') ." ". $this->lang->line('department'); ?></th>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="formadd" action="<?php echo site_url('admin/hospitaldepartment/add') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="editformadd" action="<?php echo site_url('admin/hospitaldepartment/edit') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
...
<script>
    $(document).ready(function () {
        ...
        var table = $("#dt_table").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?php echo site_url('admin/hospitaldepartment/get') ?>", "type": "POST"},
            columns: [
    ...
    function get(id) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url(); ?>admin/hospitaldepartment/get_data/' + id,
    ...
    {
        delete_recordById('<?php echo base_url() ?>admin/hospitaldepartment/departmentdelete/' + id, '<?php echo $this->lang->line('delete_message') ?>');
    }
</script>