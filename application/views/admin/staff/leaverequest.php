                            ...
                            <?php } if ($this->rbac->hasPrivilege('approve_leave_request', 'can_view')) { ?>
                                <a href="<?PHP echo base_url(); ?>admin/leaverequest/approveleaverequest" class="btn btn-primary btn-sm">
                                    <!--<i class="fa fa-reorder"></i> <?php echo $this->lang->line('approve_leave_request'); ?></a>-->
                                     <i class="fa fa-reorder"></i> <?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('status'); ?></a>
                            <?php } ?>
                        </small>
                    ...
                    <form role="form" id="addleave_form" method="post" enctype="multipart/form-data" action="">
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" readonly name="leavedates" class="form-control pull-right daterangee" id="reservation">
                            </div>
    ...
    function getLeaveTypeDDL(id, lid = '') {
       ...
       // alert(id);
        $.ajax({
            ...
            dataType: "json",
            success: function (result) {
               // alert(result.pending_leaves);
                if(result.pending_leaves > 0 && lid == ''){
                    alert('<?php echo $this->lang->line('pending_leave_alert'); ?>')
                }else{
          ...
          if(leave_bal != ''){
           if(daysCount>leave_bal){
            ...
            $('#reservation').val(''); // Assuming the input field has the id 'reservation'
               $('#reservation').focus();
               $("#addleave_formbtn").attr("disabled", true);
            alert('Leave Type can not be Empty');
        } 
