                ...
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <?php if ($this->rbac->hasPrivilege('designation', 'can_view')) { ?>
                         ...
                         <?php } if ($this->rbac->hasPrivilege('department', 'can_view')) { ?>
                            <li><a href="<?php echo base_url(); ?>admin/hospitaldepartment/">Hospital <?php echo $this->lang->line('department'); ?></a></li>
                        <?php } ?>   
                    ...
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('designation', 'can_add')) { ?>
                                <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('specialist'); ?></a>    
                            <?php } ?> 
                        </div>
                    </div>
                    <div class="box-body">
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"> <?php echo $this->lang->line('edit'); ?>  <?php echo $this->lang->line('specialist'); ?></h4> 
            </div>
