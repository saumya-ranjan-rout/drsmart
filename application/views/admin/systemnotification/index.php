                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <button class="btn btn-primary btn-sm checkbox-toggle" autocomplete="off" onclick="delete_all()"><i class="fa fa-trash"></i> <?php echo $this->lang->line('delete') ." ". $this->lang->line('all'); ?></button>
                        </div>
...
<script type="text/javascript">
    ...
    function delete_all() {
        ...
        if (confirm("Are you sure want to delete ?")) {
            $.ajax({
                url: '<?php echo base_url(); ?>admin/systemnotification/delete_all/',
                type: 'POST',
                dataType: "json",
                success: function(res) {
                    if (res.status == "fail") {
                        ...
                        setTimeout(function() {
                            window.location.reload(); // Reload page after 500ms
                        }, 500);
                    }
                }
