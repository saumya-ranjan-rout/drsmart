                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        foreach ($charge_type as $ckey => $value) {
                            // Transform key for the tab ID
                            $ckey_no_spaces = str_replace(' ', '_', $ckey);
                            ?>
                            <!--<li class="<?php
                            if ($j == 0) {
                                echo "active";
                            ...
                            ?>"><a href="#<?php echo $ckey ?>" data-toggle="tab" aria-expanded="true"><?php echo $value ?></a></li>-->
                                ...
                                <a href="#<?php echo $ckey_no_spaces; ?>" data-toggle="tab" aria-expanded="true">
                                    <?php echo $value; ?>
                                </a>
                            </li>
                                <?php
                    ...
                    <div class="tab-content">
                        ...
                        foreach ($charge_type_no_spaces as $key_no_spaces => $value) {
                            ?>
                                    ...
                                    <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            //if (!empty($org[$key])) {
                                              ...
                                              if (!empty($org[$key_no_spaces])) {
                                                foreach ($org[$key_no_spaces] as $keys => $orgvalue) {
                                                    ?>  
                                                    <tr>
                ...
                <table class="table table-striped table-bordered">                     
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-right">                                                
                                <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" name="org_charge" id="org_charge_data" class="form-control text-right">
