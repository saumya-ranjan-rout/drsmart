                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="display:flex;">
                                            ...
                                            <input id="number" autocomplete="off" name="number" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="" class="form-control" value="<?php echo set_value('contact_no'); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="display:flex;">
                                            ...
                                            <input id="number3" autocomplete="off" name="number3" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="" class="form-control" value="<?php echo set_value('contact_person_phone'); ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div><!--./row-->
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="display:flex;">
                                            ...
                                            <input id="number2" autocomplete="off" name="number2" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="" class="form-control" value="<?php echo set_value('contact_no'); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="display:flex;">
                                            ...
                                            <input id="number4" autocomplete="off" name="number4" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="" class="form-control" value="<?php echo set_value('contact_person_phone'); ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div><!--./row-->
