                                        ...
                                        ?>
                                            <tr class="">
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <?php if ($this->rbac->hasPrivilege('ot_patient', 'can_view')) { ?>
                                                        <a href="#"
                                                            onclick="viewDetail('<?php echo $optpatient['pid'] ?>','<?php echo $optpatient['id'] ?>')"
                                                    ...
                                                    <?php if ($this->rbac->hasPrivilege('ot_patient', 'can_view')) { ?>
                                                        ...
                                                        <a href="#"
                                                            onclick="printData('<?php echo $optpatient['id'] ?>')"
                                                            class="btn btn-default btn-xs" data-toggle="tooltip"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php //echo set_value('email');     
                                                                            ?>" id="date" name="date" class="form-control date">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div id="charge_reload">
                                                    ...
                                                    <select class="form-control" onchange="getchargecode(this.options[this.selectedIndex].text)" name='charge_category_id'>
    <option value="<?php echo set_value('charge_category_id'); ?>"><?php echo $this->lang->line('select') ?></option>
    <?php foreach ($charge_category as $dkey => $dvalue) { ?>
    ...
    <?php } ?>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <small class="req">*</small>
                                                <div>
                                                    <input class="form-control" type="text" name="apply_charge" id="apply_charge" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="payment_mode" id="payment_mode" onchange="showPaymentByMode(this.value)">
            ...
            <div class="modal-header modal-media-header">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-8">
                        <div class="form-group15">
                            <div>
                                <select onchange="get_ePatientDetails(this.value)" class="form-control select2"
                                    <?php
                                    if ($disable_option == true) {
                                        echo "disabled";
                                    }
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <small class="req">*</small>
                                                <div>
                                                    <select class="form-control" name='charge_category_id' id="edit_charge_category" onchange="editchargecode(this.options[this.selectedIndex].text)">
                                                        <option value="<?php echo set_value('charge_category_id'); ?>"><?php echo $this->lang->line('select') ?></option>
                                                        <?php foreach ($charge_category as $dkey => $dvalue) {
                                                        ?>
                                                            <option value="<?php echo $dvalue["id"]; ?>"><?php echo $dvalue["name"] ?></option>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <small class="req">*</small>
                                                <div>
                                                    <select class="form-control" name='code' onchange="getchargeDetails(this.value, 'edit_standard_charge')" id="edit_code">
                                                        <option value="<?php echo set_value('code'); ?>"><?php echo $this->lang->line('select') ?></option>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <small class="req">*</small>
                                                <div>
                                                    <input class="form-control" name='apply_charge' id="edit_apply_charge" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('payment') . " " . $this->lang->line('mode'); ?></label>
                                                <select class="form-control" name="payment_mode" id="epayment_mode" onchange="showPaymentByMode(this.value)">
                                                    <?php foreach ($payment_mode as $key => $value) {
                                                    ?>
                                                        <option value="<?php echo $key ?>"
                                                            <?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped table-bordered table-hover" id="tableID">
                                    ...
                                    <tr id="row0">
                                        <td>
                                            <input type="text" name="date[]" value="" class="form-control"  id="date0">
                                        ...
                                        <td>
                                            <input value="" type="text" name="insdate[]" class="form-control" id="insdate0">
                                        </td>
    ...
    function viewDetailBill(id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#edit_deletebill').html("<?php if ($this->rbac->hasPrivilege('ot_print_header_footer', 'can_view')) { ?><a href='#' data-toggle='tooltip' onclick='printData(" + id + ")'   data-original-title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a> <?php } ?><?php if ($this->rbac->hasPrivilege('ot_print_header_footer', 'can_edit')) { ?><a href='#'' onclick='getRecord(" + id + ")' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php } ?><?php if ($this->rbac->hasPrivilege('ot_print_header_footer', 'can_edit')) { ?><a onclick='delete_bill(" + id + ")'  href='#'  data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('delete'); ?>'><i class='fa fa-trash'></i></a><?php } ?>");
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res) {
                    ...
                    $("#identity_number").html(res.identity_number);
                    $("#tpa").html(res.organisation_name);
                $("#tpa_id").html(res.tpa_id);
                $("#tpa_validity").html(res.tpa_validity);
                $("#barcodee").html(
...
$("#qrcodee").html(
    '<img class="" src="<?php echo base_url(); ?>uploads/qrcode/' + res.id + '.png" id="" alt="User profile picture"width="60" height="60">'
                ...
                $("#alt_no").html(res.alternative_no);
                    $("#note").html(res.note);
...
<script type="text/javascript">
    ...
    function editchargecode(charge_category, code) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $('#edit_code').html("<option value=''><?php echo $this->lang->line('select') ?></option>");
    ...
    function getRecord(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#edit_charge_category").val(data.charge_categories_id);
                editchargecode(data.charge_categories_name, data.cid);
    ...
    function viewDetail(pid,id) {
     
        $.ajax({
            url: '<?php echo base_url(); ?>admin/operationtheatre/getOperationDetails',
            type: "POST",
            data: {
                id: id,
                patient_id: pid
            ...
            success: function(data) {
                ...
                $('#edit_delete').html("<?php if ($this->rbac->hasPrivilege('ot_patient', 'can_edit')) { ?><a href='#'' onclick='getRecord(" + data.id + ")' data-target='#editModal' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php }
                                                                                                                                                                                                                                                                                                        if ($this->rbac->hasPrivilege('ot_patient', 'can_delete')) { ?><a href='#' data-toggle='tooltip'  onclick='delete_record(" + id + ")' data-original-title='<?php echo $this->lang->line('delete'); ?>'><i class='fa fa-trash'></i></a><?php } ?>");
                holdModal('viewModal');
            },
        })
    }
    ...
    /////view/operationtheatre/otsearch.php
    $(document).ready(function() {
        $('#organisation').change(function() {
            $("#charge_reload").load(" #charge_reload > *");
