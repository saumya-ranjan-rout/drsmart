                        ...
                        <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-right"><?php echo "Paid Amount" . " (" . $currency_symbol . ")"; ?>
                                    </th>
                                    <th class="text-right"><?php echo "Balance Amount" . " (" . $currency_symbol . ")"; ?>
                                    </th>
                ...
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><?php echo "Charge Category"; ?></label><small class="req"> *</small>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="exampleInputFile">Standard Charge <?php echo '(' . $currency_symbol . ')'; ?>
                                    </label><small class="req">*</small>
                                    <div>
                                        <input class="form-control" name="standard_charge" id="standard_charge" autocomplete="off">
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right ipdbilltable">
                                                ...
                                                <input type="number" placeholder="Tax" name="tax_percentage" id="tax_percentage" class="form-control" style="width: 70%; float: right;font-size: 12px;">
                                            </td>
                                            <td class="text-right ipdbilltable">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="payment_amount" id="payment_amount" class="form-control payment_amount text-right">
                                            <span class="text-danger"></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input class="form-control" name="estandard_charge" id="estandard_charge" autocomplete="off" value="<?php echo set_value('amount'); ?>">
                                    </div>
                                    <span class="text-danger"></span>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <table class="printablea4">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right ipdbilltable">
                                                <h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4>
                                                <input type="number" placeholder="Tax" name="etax_percentage" id="etax_percentage" class="form-control" style="width: 70%; float: right;font-size: 12px;">
                                            </td>
                                            <td class="text-right ipdbilltable">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Payment Amount ($)</label><small class="req"> *</small>
                                            <input type="number" name="epayment_amount" id="epayment_amount" class="form-control payment_amount text-right">
                                            <span class="text-danger"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="apayment_amount" id="apayment_amount" class="form-control payment_amount text-right">
                                            <span class="text-danger"></span>
                                        </div>
                                    </div>
                                </div>
    ...
    function getRecord(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var chrgmood = $('#epayment_mode').select2();
                ...
                chrgmood.val(data.payment_mood).select2('').select2();
                $("#id").val(data.id);
    ...
    function getPayRecord(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var paidAmount = parseFloat(data.paid_amount);
