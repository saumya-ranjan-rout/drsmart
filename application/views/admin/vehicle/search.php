                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input  name="manufacture_year" placeholder="" type="text" class="form-control" value="<?php echo set_value('manufacture_year'); ?>"  oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                ...
                                <!--<div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('driver_contact'); ?></label><small class="req"> *</small>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="display:flex;">
                                            ...
                                            <input id="number" autocomplete="off" name="number"  type="text" placeholder="" class="form-control"  oninput="this.value = this.value.replace(/[^0-9]/g, '');" value="<?php echo set_value('driver_contact'); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                        ...
                        <form id="formedit" accept-charset="utf-8" class="ptt10">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('year_made'); ?> </label>
                                        <input id="manufacture_years" name="manufacture_year" type="text" class="form-control"  value="<?php echo set_value('manufacture_year'); ?>"  oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                               ...
                               <!-- <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="input-group" style="display:flex;">
                                            ...
                                            <input id="number2" autocomplete="off" name="number2"  type="text" placeholder="" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '');"  value="<?php echo set_value('driver_contact'); ?>" />
                                        </div>
                                    </div>
                                </div> 
                                <div class="col-sm-4">
...
<script type="text/javascript">
            ...
            function getRecord(id) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    success: function (data) {
                    var mobileno = data.driver_contact;
