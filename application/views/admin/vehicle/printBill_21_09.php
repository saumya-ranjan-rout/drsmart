                ...
                <div class="">
                    ...
                    <table class="printablea4" cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td width="25%"><?php echo $result["charge_category"]; ?></td>
                            <th width="25%"><?php echo $this->lang->line('payment') . " " . $this->lang->line('mode'); ?></th>
                            <td width="30%" align="left"><?php echo $result['payment_mode']; ?></td> 
                        </tr> 
                    </table>
                    <hr style="height: 1px; clear: both;margin-bottom: 10px; margin-top: 10px">
                    <table class="printablea4" id="testreport"style="width:50%;">
                         <tr>
                        ...
                        <tr>
                            ...
                            <td><?php 
                             if (isset($result['tax_amount']) && isset($result['standard_charge']) && $result['standard_charge'] != 0) {
                                $per = ($result['tax_amount'] * 100) / $result['standard_charge'];
                                echo '(' . number_format($per, 2) . '%) ' . number_format($result['tax_amount'], 2);
                            } else {
                                echo 'Invalid data';
                            } ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?php echo number_format($result['paid_amount'],2); ?></td>
                        </tr>
                        <tr>

                            <th><?php echo $this->lang->line('due') . " " . $this->lang->line('amount'); ?></th>
                            <td><?php echo number_format($result['amount']-$result['paid_amount'],2); ?></td>
                        </tr>
                        <!-- <tr>
