                                    ...
                                    if (empty($itemlist)) {
                                        ...
                                        foreach ($itemlist as $items) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php echo number_format($items['purchase_price'], 2) ; ?>
                    ...
                    <div class="row ptt10">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="">
                                    ...
                                    <input id="quantity" name="quantity" placeholder="" type="text" class="form-control miplusinput"  value="<?php echo set_value('quantity'); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">        
                                ...
                                <input id="purchase_price" name="purchase_price" placeholder="" type="text" class="form-control"  value="<?php echo set_value('purchase_price'); ?>"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input id="" name="date" placeholder="" type="text" class="form-control datee"  value="<?php echo date('d-m-Y'); ?>" readonly="readonly" />
                    ...
                    <div class="row ptt10">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="">
                                    ...
                                    <input id="editquantity" name="quantity" placeholder="" type="text" class="form-control miplusinput"  value="<?php echo set_value('quantity'); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input id="epurchase_price" name="purchase_price" placeholder="" type="text" class="form-control purchase_price"  value="<?php echo set_value('purchase_price'); ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"  />
                                <span class="text-danger"><?php echo form_error('purchase_price'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('date'); ?></label>
                                <input id="editdate" name="date" placeholder="" type="text" class="form-control datee"  value="<?php echo set_value('date'); ?>" readonly="readonly" />
                                <span class="text-danger"><?php echo form_error('date'); ?></span>
                            </div>
                        </div>
    ...
    function get_data(id) {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                var formatted_date = formatDate(dt, date_format);
                $("#editdate").val(formatted_date);
