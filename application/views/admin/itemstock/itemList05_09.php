                    ...
                    <div class="row ptt10">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="">
                                    ...
                                    <input id="quantity" name="quantity" placeholder="" type="number" class="form-control miplusinput"  value="<?php echo set_value('quantity'); ?>" />
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">        
                                ...
                                <input id="purchase_price" name="purchase_price" placeholder="" type="number" class="form-control"  value="<?php echo set_value('purchase_price'); ?>"  />
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input id="date" name="date" placeholder="" type="text" class="form-control"  value="<?php echo date('d-m-Y'); ?>" readonly="readonly" />
                    ...
                    <div class="row ptt10">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="">
                                    ...
                                    <input id="editquantity" name="quantity" placeholder="" type="number" class="form-control miplusinput"  value="<?php echo set_value('quantity'); ?>" />
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input id="epurchase_price" name="purchase_price" placeholder="" type="number" class="form-control purchase_price"  value="<?php echo set_value('purchase_price'); ?>"  />
                                <span class="text-danger"><?php echo form_error('purchase_price'); ?></span>
                            </div>
                        </div>
