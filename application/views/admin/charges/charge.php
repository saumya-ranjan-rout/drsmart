                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="standard_charge" id="standard_charge" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">    
                                        <span class="text-danger"><?php echo form_error('code'); ?></span>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <table class="printablea4">
                                                <?php foreach ($schedule as $category) { ?>
                                                    ...
                                                    <td class="col-sm-4"><input type="text" name="schedule_charge[]" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"></td>
                                                    </tr>
                                                <?php } ?>
                                            </table>
                        ...
                        <form id="formedit" accept-charset="utf-8" method="post" class="ptt10">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('standard') . " " . $this->lang->line('charge') . " (" . $currency_symbol . ")"; ?></label><small class="req"> *</small> 
                                        <input type="text" id="standard" name="standard_charge"  value="<?php echo set_value('standard_charge'); ?>"  class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">    
...
<script type="text/javascript">
    ...
    function getChargeCategory(charge_type, charge_category) {
        var base_url = '<?php echo base_url() ?>';
        var dropdown = $('#edit_charge_category');
        
        // Clear any existing options and show "Loading..." initially
        dropdown.html("<option value=''><?php echo $this->lang->line('loading') ?></option>");
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function (i, obj) {
                    var selected = charge_category === obj.name ? "selected" : "";
                    options += "<option value='" + obj.name + "' " + selected + ">" + obj.name + "</option>";
                });
