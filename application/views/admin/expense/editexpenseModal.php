...
$this->session->unset_userdata('msg'); ?>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input id="" name="date" placeholder="" type="text" class="form-control datee"  value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($expense['date']))); ?>" readonly="readonly" />
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input id="amount" name="amount" placeholder="" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control"  value="<?php echo set_value('amount', $expense['amount']); ?>" />
