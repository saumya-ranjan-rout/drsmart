                        ...
                        <div class="col-lg-5 col-sm-5 <?php echo $offset; ?> form-box">
                            <div class="loginbg">
                                ...
                                <div class="form-bottom">
                                    ...
                                    <h3 class="font-white"><?php echo 'Patient Login'; ?></h3>
                                    <?php
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                          <!--  <p><a href="<?php echo site_url('site/ufpassword') ?>" class="forgot"> 
                                                <i class="fa fa-key"></i> <?php echo $this->lang->line('forgot_password'); ?></a> 
                                            </p>-->
<img src="<?php echo base_url() . "uploads/hospital_content/logo/01.png"?>" class="logowidth">
                                        </div>
                                        <div class="col-md-6">
                                            <a href="<?php echo site_url('site/login') ?>" class="btn btn-warning pull-right" >
                                                Staff Login
                                            </a>
                                        </div>
                                    </div>
