                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4"><strong><?php echo $this->lang->line('hospital') . " " . $this->lang->line('name'); ?></strong></label>
                                    <div class="col-sm-8">
                                        <span class="mailbox-name"> <?php echo $settinglist[0]['name'] ?></span>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4"><strong><?php echo $this->lang->line('address'); ?></strong></label>
                                    <div class="col-sm-8">
                                        <span class="mailbox-name"> <?php echo $settinglist[0]['address'] ?></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4"><strong><?php echo $this->lang->line('phone'); ?></strong></label>
                                    <div class="col-sm-8">
                                        <span class="mailbox-name"> <?php echo $settinglist[0]['phone'] ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4"><strong><?php echo $this->lang->line('email'); ?></strong></label>
                                    <div class="col-sm-8">
                                        <span class="mailbox-name"> <?php echo $settinglist[0]['email'] ?></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="col-sm-2"><strong><?php echo $this->lang->line('hospital') . " " . $this->lang->line('code'); ?></strong></label>
                                    <div class="col-sm-10">
                                        <span class="mailbox-name"> <?php echo $settinglist[0]['dise_code'] ?></span>
                                    </div>
                                </div>
                            </div>
                        </div><!--./row-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h4 class="session-head"><?php echo $this->lang->line('logo'); ?></h4>
                            </div><!--./col-md-12-->
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4"><?php echo $this->lang->line('hospital') . " " . $this->lang->line('logo'); ?></label>
                                    <div class="col-sm-8">
                                        <?php
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4"><?php echo $this->lang->line('hospital') . " " . $this->lang->line('small') . " " . $this->lang->line('logo'); ?></label>
                                    <div class="col-sm-8">
                                        <?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4"><strong><?php echo $this->lang->line('language'); ?></strong></label>
                                    <div class="col-sm-8">
                                        <span class="mailbox-name"> <?php echo $settinglist[0]['language'] ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4"><strong><?php echo $this->lang->line('language_rtl_text_mode'); ?></strong></label>
                                    <div class="col-sm-8">
                                        <span class="mailbox-name"> <?php echo ucfirst($settinglist[0]['is_rtl']); ?></span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4"><strong><?php echo $this->lang->line('timezone'); ?></strong></label>
                                    <div class="col-sm-8">
                                        <span class="mailbox-name"> <?php echo $settinglist[0]['timezone'] ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4"><strong><?php echo $this->lang->line('date_format'); ?></strong></label>
                                    <div class="col-sm-8">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="col-sm-2"><strong><?php echo $this->lang->line('time_format') ?></strong></label>
                                    <div class="col-sm-10">
                                        <span class="mailbox-name">
                                            <?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4"><strong><?php echo $this->lang->line('currency'); ?></strong></label>
                                    <div class="col-sm-8">
                                        <span class="mailbox-name"> <?php echo $settinglist[0]['currency'] ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4"><strong><?php echo $this->lang->line('currency_symbol'); ?></strong></label>
                                    <div class="col-sm-8">
                                        <span class="mailbox-name"> <?php echo $settinglist[0]['currency_symbol'] ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <label class="col-sm-4"><strong><?php echo $this->lang->line('credit_limit'); ?></strong></label>
                                    <div class="col-sm-8">
                                        <span class="mailbox-name"> <?php echo $currency_symbol . $settinglist[0]['credit_limit'] ?></span>
                                    </div>
                                </div>
                            </div>
                        </div><!--./row-->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-6"><strong><?php echo $this->lang->line('doctor_restriction_mode'); ?></strong></label>
                                    <div class="col-sm-6">
                                        <span class="mailbox-name"><?php echo ucfirst($settinglist[0]['doctor_restriction']) ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-6"> <strong><?php echo $this->lang->line('superadmin_restriction'); ?></strong></label>
                                    <div class="col-sm-6">
                                        <span class="mailbox-name"><?php echo ucfirst($settinglist[0]['superadmin_restriction']) ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <form role="form" id="schsetting_form" action="<?php echo site_url('schsettings/ajaxedit') ?>">
                        ...
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="input-group" style="display:flex;">
                                ...
                                <input id="number" autocomplete="off" name="number" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="" class="form-control" value="<?php echo set_value('sch_phone'); ?>" />
                                <span class="text-danger"><?php echo form_error('phone'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <input class="form-control" id="email" name="sch_email" placeholder="" type="email" />
