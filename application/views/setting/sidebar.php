        ...
        <ul class="tablists">
            ...
            if ($this->rbac->hasPrivilege('sms_setting', 'can_view')) { ?>
                <!-- <li>
                    ...
                    <a class="<?php echo set_Innermenu('smsconfig/index'); ?>" href="<?php echo base_url(); ?>smsconfig"><?php echo $this->lang->line('sms_setting'); ?></a>
                </li> -->
            <?php }
            ...
            if ($this->rbac->hasPrivilege('front_cms_setting', 'can_view')) { ?>
                <!-- <li><a class="<?php echo set_Innermenu('admin/frontcms/index'); ?>" href="<?php echo base_url(); ?>admin/frontcms"><?php echo $this->lang->line('front_cms_setting'); ?></a></li>  --> <?php } ?>
            ...
            <?php if ($this->rbac->hasPrivilege('prefix_setting', 'can_view')) { ?>
                <li><a class="<?php echo set_Innermenu('admin/prefix'); ?>" href="<?php echo base_url(); ?>admin/prefix"><?php echo $this->lang->line('prefix_setting'); ?></a></li>
            <?php } ?> 
